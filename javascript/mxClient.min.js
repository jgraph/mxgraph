...
mxCodec.prototype.getElementById=function(a){return typeof this.document.getElementById==="function"&&!mxClient.IS_IE&&document.documentMode==null?this.document.getElementById(a):mxUtils.findNode(this.document.documentElement,"id",a)};mxCodec.prototype.getId=function(a){var b=null;if(a!=null){b=this.reference(a);if(b==null&&a instanceof mxCell){b=a.getId();if(b==null){b=mxCellPath.create(a);b.length==0&&(b="root")}}}return b};mxCodec.prototype.reference=function(){return null};
