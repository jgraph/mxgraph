var mxClient={VERSION:"1.13.0.16",IS_IE:0<=navigator.userAgent.indexOf("MSIE"),IS_IE6:0<=navigator.userAgent.indexOf("MSIE 6"),IS_IE11:!!navigator.userAgent.match(/Trident\/7\./),IS_QUIRKS:0<=navigator.userAgent.indexOf("MSIE")&&(null==document.documentMode||5==document.documentMode),IS_NS:0<=navigator.userAgent.indexOf("Mozilla/")&&0>navigator.userAgent.indexOf("MSIE"),IS_OP:0<=navigator.userAgent.indexOf("Opera/"),IS_OT:0>navigator.userAgent.indexOf("Presto/2.4.")&&0>navigator.userAgent.indexOf("Presto/2.3.")&&
0>navigator.userAgent.indexOf("Presto/2.2.")&&0>navigator.userAgent.indexOf("Presto/2.1.")&&0>navigator.userAgent.indexOf("Presto/2.0.")&&0>navigator.userAgent.indexOf("Presto/1."),IS_SF:0<=navigator.userAgent.indexOf("AppleWebKit/")&&0>navigator.userAgent.indexOf("Chrome/"),IS_GC:0<=navigator.userAgent.indexOf("Chrome/"),IS_MT:0<=navigator.userAgent.indexOf("Firefox/")&&0>navigator.userAgent.indexOf("Firefox/1.")&&0>navigator.userAgent.indexOf("Firefox/2.")||0<=navigator.userAgent.indexOf("Iceweasel/")&&
0>navigator.userAgent.indexOf("Iceweasel/1.")&&0>navigator.userAgent.indexOf("Iceweasel/2.")||0<=navigator.userAgent.indexOf("SeaMonkey/")&&0>navigator.userAgent.indexOf("SeaMonkey/1.")||0<=navigator.userAgent.indexOf("Iceape/")&&0>navigator.userAgent.indexOf("Iceape/1."),IS_SVG:0<=navigator.userAgent.indexOf("Firefox/")||0<=navigator.userAgent.indexOf("Iceweasel/")||0<=navigator.userAgent.indexOf("Seamonkey/")||0<=navigator.userAgent.indexOf("Iceape/")||0<=navigator.userAgent.indexOf("Galeon/")||
0<=navigator.userAgent.indexOf("Epiphany/")||0<=navigator.userAgent.indexOf("AppleWebKit/")||0<=navigator.userAgent.indexOf("Gecko/")||0<=navigator.userAgent.indexOf("Opera/")||null!=document.documentMode&&9<=document.documentMode,NO_FO:0<=navigator.userAgent.indexOf("Firefox/1.")||0<=navigator.userAgent.indexOf("Iceweasel/1.")||0<=navigator.userAgent.indexOf("Firefox/2.")||0<=navigator.userAgent.indexOf("Iceweasel/2.")||0<=navigator.userAgent.indexOf("SeaMonkey/1.")||0<=navigator.userAgent.indexOf("Iceape/1.")||
0<=navigator.userAgent.indexOf("Camino/1.")||0<=navigator.userAgent.indexOf("Epiphany/2.")||0<=navigator.userAgent.indexOf("Opera/")||0<=navigator.userAgent.indexOf("MSIE")||0<=navigator.userAgent.indexOf("Mozilla/2."),IS_VML:"MICROSOFT INTERNET EXPLORER"==navigator.appName.toUpperCase(),IS_MAC:0<navigator.userAgent.toUpperCase().indexOf("MACINTOSH"),IS_TOUCH:0<navigator.userAgent.toUpperCase().indexOf("IPAD")||0<navigator.userAgent.toUpperCase().indexOf("IPOD")||0<navigator.userAgent.toUpperCase().indexOf("IPHONE")||
0<navigator.userAgent.toUpperCase().indexOf("ANDROID"),IS_LOCAL:0>document.location.href.indexOf("http://")&&0>document.location.href.indexOf("https://"),isBrowserSupported:function(){return mxClient.IS_VML||mxClient.IS_SVG},link:function(a,b,c){c=c||document;if(mxClient.IS_IE6)c.write('<link rel="'+a+'" href="'+b+'" charset="ISO-8859-1" type="text/css"/>');else{var d=c.createElement("link");d.setAttribute("rel",a);d.setAttribute("href",b);d.setAttribute("charset","ISO-8859-1");d.setAttribute("type",
"text/css");c.getElementsByTagName("head")[0].appendChild(d)}},include:function(a){document.write('<script src="'+a+'"><\/script>')},dispose:function(){for(var a=0;a<mxEvent.objects.length;a++)null!=mxEvent.objects[a].mxListenerList&&mxEvent.removeAllListeners(mxEvent.objects[a])}};"undefined"==typeof mxLoadResources&&(mxLoadResources=!0);"undefined"==typeof mxLoadStylesheets&&(mxLoadStylesheets=!0);
...
mxClient.IS_VML&&(mxClient.IS_SVG?mxClient.IS_VML=!1:(8==document.documentMode?(document.namespaces.add("v","urn:schemas-microsoft-com:vml","#default#VML"),document.namespaces.add("o","urn:schemas-microsoft-com:office:office","#default#VML")):(document.namespaces.add("v","urn:schemas-microsoft-com:vml"),document.namespaces.add("o","urn:schemas-microsoft-com:office:office")),mxClient.IS_QUIRKS&&30<=document.styleSheets.length?function(){var a=document.createElement("style");a.type="text/css";a.styleSheet.cssText=
"v\\:*{behavior:url(#default#VML)}o\\:*{behavior:url(#default#VML)}";document.getElementsByTagName("head")[0].appendChild(a)}():document.createStyleSheet().cssText="v\\:*{behavior:url(#default#VML)}o\\:*{behavior:url(#default#VML)}",mxLoadStylesheets&&mxClient.link("stylesheet",mxClient.basePath+"/css/explorer.css")),window.attachEvent("onunload",mxClient.dispose));
...
a){delete b[e];c=a}return c},isNode:function(a,b,c,d){return a!=null&&!isNaN(a.nodeType)&&(b==null||a.nodeName.toLowerCase()==b.toLowerCase())?c==null||a.getAttribute(c)==d:false},getChildNodes:function(a,b){for(var b=b||mxConstants.NODETYPE_ELEMENT,c=[],d=a.firstChild;d!=null;){d.nodeType==b&&c.push(d);d=d.nextSibling}return c},importNode:function(a,b,c){if(mxClient.IS_IE&&(document.documentMode==null||document.documentMode<10))switch(b.nodeType){case 1:var d=a.createElement(b.nodeName);if(b.attributes&&
b.attributes.length>0){for(var e=0;e<b.attributes.length;e++)d.setAttribute(b.attributes[e].nodeName,b.getAttribute(b.attributes[e].nodeName));if(c&&b.childNodes&&b.childNodes.length>0)for(e=0;e<b.childNodes.length;e++)d.appendChild(mxUtils.importNode(a,b.childNodes[e],c))}return d;case 3:case 4:case 8:return a.createTextNode(b.nodeValue)}else return a.importNode(b,c)},createXmlDocument:function(){var a=null;document.implementation&&document.implementation.createDocument&&document.documentMode!=9?
...
function(){window.getSelection().removeAllRanges()}:function(){}}(),getPrettyXml:function(a,b,c){var d=[];if(a!=null){b=b||"  ";c=c||"";if(a.nodeType==mxConstants.NODETYPE_TEXT)d.push(a.nodeValue);else{d.push(c+"<"+a.nodeName);var e=a.attributes;if(e!=null)for(var f=0;f<e.length;f++){var g=mxUtils.htmlEntities(e[f].nodeValue);d.push(" "+e[f].nodeName+'="'+g+'"')}e=a.firstChild;if(e!=null){for(d.push(">\n");e!=null;){d.push(mxUtils.getPrettyXml(e,b,c+b));e=e.nextSibling}d.push(c+"</"+a.nodeName+">\n")}else d.push("/>\n")}}return d.join("")},
removeWhitespace:function(a,b){for(var c=b?a.previousSibling:a.nextSibling;c!=null&&c.nodeType==mxConstants.NODETYPE_TEXT;){var d=b?c.previousSibling:c.nextSibling,e=mxUtils.getTextContent(c);mxUtils.trim(e).length==0&&c.parentNode.removeChild(c);c=d}},htmlEntities:function(a,b){a=(a||"").replace(/&/g,"&amp;");a=a.replace(/"/g,"&quot;");a=a.replace(/\'/g,"&#39;");a=a.replace(/</g,"&lt;");a=a.replace(/>/g,"&gt;");if(b==null||b)a=a.replace(/\n/g,"&#xa;");return a},isVml:function(a){return a!=null&&
a.tagUrn=="urn:schemas-microsoft-com:vml"},getXml:function(a,b){var c="";window.XMLSerializer!=null&&document.documentMode!=9?c=(new XMLSerializer).serializeToString(a):a.xml!=null&&(c=a.xml.replace(/\r\n\t[\t]*/g,"").replace(/>\r\n/g,">").replace(/\r\n/g,"\n"));return c=c.replace(/\n/g,b||"&#xa;")},getTextContent:function(a){return a!=null?a[a.textContent===void 0?"text":"textContent"]:""},setTextContent:function(a,b){a[a.textContent===void 0?"text":"textContent"]=b},getInnerHtml:function(){return mxClient.IS_IE?
function(a){return a!=null?a.innerHTML:""}:function(a){return a!=null?(new XMLSerializer).serializeToString(a):""}}(),getOuterHtml:function(){return mxClient.IS_IE?function(a){if(a!=null){if(a.outerHTML!=null)return a.outerHTML;var b=[];b.push("<"+a.nodeName);var c=a.attributes;if(c!=null)for(var d=0;d<c.length;d++){var e=c[d].nodeValue;if(e!=null&&e.length>0){b.push(" ");b.push(c[d].nodeName);b.push('="');b.push(e);b.push('"')}}if(a.innerHTML.length==0)b.push("/>");else{b.push(">");b.push(a.innerHTML);
b.push("</"+a.nodeName+">")}return b.join("")}return""}:function(a){return a!=null?(new XMLSerializer).serializeToString(a):""}}(),write:function(a,b){var c=a.ownerDocument.createTextNode(b);a!=null&&a.appendChild(c);return c},writeln:function(a,b){var c=a.ownerDocument.createTextNode(b);if(a!=null){a.appendChild(c);a.appendChild(document.createElement("br"))}return c},br:function(a,b){for(var b=b||1,c=null,d=0;d<b;d++)if(a!=null){c=a.ownerDocument.createElement("br");a.appendChild(c)}return c},button:function(a,
b,c){c=c!=null?c:document;c=c.createElement("button");mxUtils.write(c,a);mxEvent.addListener(c,"click",function(a){b(a)});return c},para:function(a,b){var c=document.createElement("p");mxUtils.write(c,b);a!=null&&a.appendChild(c);return c},linkAction:function(a,b,c,d,e){return mxUtils.link(a,b,function(){c.execute(d)},e)},linkInvoke:function(a,b,c,d,e,f){return mxUtils.link(a,b,function(){c[d](e)},f)},link:function(a,b,c,d){var e=document.createElement("span");e.style.color="blue";e.style.textDecoration=
"underline";e.style.cursor="pointer";if(d!=null)e.style.paddingLeft=d+"px";mxEvent.addListener(e,"click",c);mxUtils.write(e,b);a!=null&&a.appendChild(e);return e},fit:function(a){var b=parseInt(a.offsetLeft),c=parseInt(a.offsetWidth),d=document.body,e=document.documentElement,f=(d.scrollLeft||e.scrollLeft)+(d.clientWidth||e.clientWidth);if(b+c>f)a.style.left=Math.max(d.scrollLeft||e.scrollLeft,f-c)+"px";b=parseInt(a.offsetTop);c=parseInt(a.offsetHeight);f=(d.scrollTop||e.scrollTop)+Math.max(d.clientHeight||
...
load:function(a){a=new mxXmlRequest(a,null,"GET",false);a.send();return a},get:function(a,b,c){return(new mxXmlRequest(a,null,"GET")).send(b,c)},post:function(a,b,c,d){return(new mxXmlRequest(a,b)).send(c,d)},submit:function(a,b,c,d){return(new mxXmlRequest(a,b)).simulate(c,d)},loadInto:function(a,b,c){mxClient.IS_IE?b.onreadystatechange=function(){b.readyState==4&&c()}:b.addEventListener("load",c,false);b.load(a)},getValue:function(a,b,c){a=a!=null?a[b]:null;a==null&&(a=c);return a},getNumber:function(a,
b,c){a=a!=null?a[b]:null;a==null&&(a=c||0);return Number(a)},getColor:function(a,b,c){a=a!=null?a[b]:null;a==null?a=c:a==mxConstants.NONE&&(a=null);return a},clone:function(a,b,c){var c=c!=null?c:false,d=null;if(a!=null&&typeof a.constructor=="function"){var d=new a.constructor,e;for(e in a)if(e!=mxObjectIdentity.FIELD_NAME&&(b==null||mxUtils.indexOf(b,e)<0))d[e]=!c&&typeof a[e]=="object"?mxUtils.clone(a[e]):a[e]}return d},equalPoints:function(a,b){if(a==null&&b!=null||a!=null&&b==null||a!=null&&
b!=null&&a.length!=b.length)return false;if(a!=null&&b!=null)for(var c=0;c<a.length;c++)if(a[c]==b[c]||a[c]!=null&&!a[c].equals(b[c]))return false;return true},equalEntries:function(a,b){if(a==null&&b!=null||a!=null&&b==null||a!=null&&b!=null&&a.length!=b.length)return false;if(a!=null&&b!=null)for(var c in a)if((!mxUtils.isNaN(a[c])||!mxUtils.isNaN(b[c]))&&a[c]!=b[c])return false;return true},isNaN:function(a){return typeof a=="number"&&isNaN(a)},extend:function(a,b){var c=function(){};c.prototype=
b.prototype;a.prototype=new c;a.prototype.constructor=a},toString:function(a){var b="",c;for(c in a)try{if(a[c]==null)b=b+(c+" = [null]\n");else if(typeof a[c]=="function")b=b+(c+" => [Function]\n");else if(typeof a[c]=="object")var d=mxUtils.getFunctionName(a[c].constructor),b=b+(c+" => ["+d+"]\n");else b=b+(c+" = "+a[c]+"\n")}catch(e){b=b+(c+"="+e.message)}return b},toRadians:function(a){return Math.PI*a/180},arcToCurves:function(a,b,c,d,e,f,g,h,k){h=h-a;k=k-b;if(c===0||d===0)return n;var c=Math.abs(c),
d=Math.abs(d),i=-h/2,l=-k/2,m=Math.cos(e*Math.PI/180),n=Math.sin(e*Math.PI/180),e=m*i+n*l,i=-1*n*i+m*l,l=e*e,o=i*i,p=c*c,q=d*d,r=l/p+o/q;if(r>1){c=Math.sqrt(r)*c;d=Math.sqrt(r)*d;f=0}else{r=1;f===g&&(r=-1);f=r*Math.sqrt((p*q-p*o-q*l)/(p*o+q*l))}l=f*c*i/d;o=-1*f*d*e/c;h=m*l-n*o+h/2;k=n*l+m*o+k/2;p=Math.atan2((i-o)/d,(e-l)/c)-Math.atan2(0,1);f=p>=0?p:2*Math.PI+p;p=Math.atan2((-i-o)/d,(-e-l)/c)-Math.atan2((i-o)/d,(e-l)/c);e=p>=0?p:2*Math.PI+p;g==0&&e>0?e=e-2*Math.PI:g!=0&&e<0&&(e=e+2*Math.PI);for(var g=
e*2/Math.PI,g=Math.ceil(g<0?-1*g:g),e=e/g,i=8/3*Math.sin(e/4)*Math.sin(e/4)/Math.sin(e/2),l=m*c,m=m*d,c=n*c,d=n*d,u=Math.cos(f),w=Math.sin(f),o=-i*(l*w+d*u),p=-i*(c*w-m*u),r=q=0,n=[],v=0;v<g;++v){var f=f+e,u=Math.cos(f),w=Math.sin(f),q=l*u-d*w+h,r=c*u+m*w+k,s=-i*(l*w+d*u),u=-i*(c*w-m*u),w=v*6;n[w]=Number(o+a);n[w+1]=Number(p+b);n[w+2]=Number(q-s+a);n[w+3]=Number(r-u+b);n[w+4]=Number(q+a);n[w+5]=Number(r+b);o=q+s;p=r+u}return n},getBoundingBox:function(a,b){var c=null;if(a!=null&&b!=null&&b!=0){var d=
mxUtils.toRadians(b),c=Math.cos(d),e=Math.sin(d),f=new mxPoint(a.x+a.width/2,a.y+a.height/2),g=new mxPoint(a.x,a.y),d=new mxPoint(a.x+a.width,a.y),h=new mxPoint(d.x,a.y+a.height),k=new mxPoint(a.x,h.y),g=mxUtils.getRotatedPoint(g,c,e,f),d=mxUtils.getRotatedPoint(d,c,e,f),h=mxUtils.getRotatedPoint(h,c,e,f),k=mxUtils.getRotatedPoint(k,c,e,f),c=new mxRectangle(g.x,g.y,0,0);c.add(new mxRectangle(d.x,d.y,0,0));c.add(new mxRectangle(h.x,h.y,0,0));c.add(new mxRectangle(k.x,k.y,0,0))}return c},getRotatedPoint:function(a,
...
k*d);i=Math.max(e,i*d);if(f>0){k=Math.min(k,f);i=Math.min(i,f)}a=new mxRectangle(g-k/2,h-i/2,k,i);return mxUtils.contains(a,b,c)}return true},getOffset:function(a,b){var c=0,d=0;if(b!=null&&b)var e=document.body,f=document.documentElement,c=c+(e.scrollLeft||f.scrollLeft),d=d+(e.scrollTop||f.scrollTop);for(;a.offsetParent;){c=c+a.offsetLeft;d=d+a.offsetTop;a=a.offsetParent}return new mxPoint(c,d)},getScrollOrigin:function(a){for(var b=document.body,c=document.documentElement,d=new mxPoint(b.scrollLeft||
c.scrollLeft,b.scrollTop||c.scrollTop);a!=null&&a!=b&&a!=c;){if(!isNaN(a.scrollLeft)&&!isNaN(a.scrollTop)){d.x=d.x+a.scrollLeft;d.y=d.y+a.scrollTop}a=a.parentNode}return d},convertPoint:function(a,b,c){var d=mxUtils.getScrollOrigin(a),a=mxUtils.getOffset(a);a.x=a.x-d.x;a.y=a.y-d.y;return new mxPoint(b-a.x,c-a.y)},ltrim:function(a,b){return a.replace(RegExp("^["+(b||"\\s")+"]+","g"),"")},rtrim:function(a,b){return a.replace(RegExp("["+(b||"\\s")+"]+$","g"),"")},trim:function(a,b){return mxUtils.ltrim(mxUtils.rtrim(a,
b),b)},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)&&(typeof a!="string"||a.toLowerCase().indexOf("0x")<0)},mod:function(a,b){return(a%b+b)%b},intersection:function(a,b,c,d,e,f,g,h){var k=(h-f)*(c-a)-(g-e)*(d-b),g=((g-e)*(b-f)-(h-f)*(a-e))/k,e=((c-a)*(b-f)-(d-b)*(a-e))/k;return g>=0&&g<=1&&e>=0&&e<=1?new mxPoint(a+g*(c-a),b+g*(d-b)):null},ptSegDistSq:function(a,b,c,d,e,f){c=c-a;d=d-b;e=e-a;f=f-b;if(e*c+f*d<=0)c=0;else{e=c-e;f=d-f;a=e*c+f*d;c=a<=0?0:a*a/(c*c+d*d)}e=e*e+f*f-c;e<0&&
(e=0);return e},relativeCcw:function(a,b,c,d,e,f){c=c-a;d=d-b;e=e-a;f=f-b;a=e*d-f*c;if(a==0){a=e*c+f*d;if(a>0){a=(e-c)*c+(f-d)*d;a<0&&(a=0)}}return a<0?-1:a>0?1:0},animateChanges:function(a,b){mxEffects.animateChanges.apply(this,arguments)},cascadeOpacity:function(a,b,c){mxEffects.cascadeOpacity.apply(this,arguments)},fadeOut:function(a,b,c,d,e,f){mxEffects.fadeOut.apply(this,arguments)},setOpacity:function(a,b){mxUtils.isVml(a)?a.style.filter=b>=100?null:"alpha(opacity="+b/5+")":mxClient.IS_IE&&
(typeof document.documentMode==="undefined"||document.documentMode<9)?a.style.filter=b>=100?null:"alpha(opacity="+b+")":a.style.opacity=b/100},createImage:function(a){var b=null;if(mxClient.IS_IE6&&document.compatMode!="CSS1Compat"){b=document.createElement("v:image");b.setAttribute("src",a);b.style.borderStyle="none"}else{b=document.createElement("img");b.setAttribute("src",a);b.setAttribute("border","0")}return b},sortCells:function(a,b){var b=b!=null?b:true,c=new mxDictionary;a.sort(function(a,
e){var f=c.get(a);if(f==null){f=mxCellPath.create(a).split(mxCellPath.PATH_SEPARATOR);c.put(a,f)}var g=c.get(e);if(g==null){g=mxCellPath.create(e).split(mxCellPath.PATH_SEPARATOR);c.put(e,g)}f=mxCellPath.compare(f,g);return f==0?0:f>0==b?1:-1});return a},getStylename:function(a){if(a!=null){a=a.split(";")[0];if(a.indexOf("=")<0)return a}return""},getStylenames:function(a){var b=[];if(a!=null)for(var a=a.split(";"),c=0;c<a.length;c++)a[c].indexOf("=")<0&&b.push(a[c]);return b},indexOfStylename:function(a,
b){if(a!=null&&b!=null)for(var c=a.split(";"),d=0,e=0;e<c.length;e++){if(c[e]==b)return d;d=d+(c[e].length+1)}return-1},addStylename:function(a,b){if(mxUtils.indexOfStylename(a,b)<0){a==null?a="":a.length>0&&a.charAt(a.length-1)!=";"&&(a=a+";");a=a+b}return a},removeStylename:function(a,b){var c=[];if(a!=null)for(var d=a.split(";"),e=0;e<d.length;e++)d[e]!=b&&c.push(d[e]);return c.join(";")},removeAllStylenames:function(a){var b=[];if(a!=null)for(var a=a.split(";"),c=0;c<a.length;c++)a[c].indexOf("=")>=
0&&b.push(a[c]);return b.join(";")},setCellStyles:function(a,b,c,d){if(b!=null&&b.length>0){a.beginUpdate();try{for(var e=0;e<b.length;e++)if(b[e]!=null){var f=mxUtils.setStyle(a.getStyle(b[e]),c,d);a.setStyle(b[e],f)}}finally{a.endUpdate()}}},setStyle:function(a,b,c){var d=c!=null&&(typeof c.length=="undefined"||c.length>0);if(a==null||a.length==0)d&&(a=b+"="+c);else{var e=a.indexOf(b+"=");if(e<0){if(d){d=a.charAt(a.length-1)==";"?"":";";a=a+d+b+"="+c}}else{b=d?b+"="+c:"";c=a.indexOf(";",e);d||c++;
a=a.substring(0,e)+b+(c>e?a.substring(c):"")}}return a},setCellStyleFlags:function(a,b,c,d,e){if(b!=null&&b.length>0){a.beginUpdate();try{for(var f=0;f<b.length;f++)if(b[f]!=null){var g=mxUtils.setStyleFlag(a.getStyle(b[f]),c,d,e);a.setStyle(b[f],g)}}finally{a.endUpdate()}}},setStyleFlag:function(a,b,c,d){if(a==null||a.length==0)a=d||d==null?b+"="+c:b+"=0";else{var e=a.indexOf(b+"=");if(e<0){e=a.charAt(a.length-1)==";"?"":";";a=d||d==null?a+e+b+"="+c:a+e+b+"=0"}else var f=a.indexOf(";",e),g="",g=
f<0?a.substring(e+b.length+1):a.substring(e+b.length+1,f),g=d==null?parseInt(g)^c:d?parseInt(g)|c:parseInt(g)&~c,a=a.substring(0,e)+b+"="+g+(f>=0?a.substring(f):"")}return a},getSizeForString:function(a,b,c,d){var e=document.createElement("div");e.style.fontSize=(b||mxConstants.DEFAULT_FONTSIZE)+"px";e.style.fontFamily=c||mxConstants.DEFAULT_FONTFAMILY;e.style.position="absolute";e.style.display="inline";e.style.visibility="hidden";e.style.display=mxClient.IS_QUIRKS?"inline":"inline-block";e.style.zoom=
"1";if(d!=null){e.style.width=d+"px";e.style.whiteSpace="normal"}else e.style.whiteSpace="nowrap";e.innerHTML=a;document.body.appendChild(e);a=new mxRectangle(0,0,e.offsetWidth,e.offsetHeight);document.body.removeChild(e);return a},getViewXml:function(a,b,c,d,e){d=d!=null?d:0;e=e!=null?e:0;b=b!=null?b:1;c==null&&(c=[a.getModel().getRoot()]);var f=a.getView(),g=null,h=f.isEventsEnabled();f.setEventsEnabled(false);var k=f.drawPane,i=f.overlayPane;if(a.dialect==mxConstants.DIALECT_SVG){f.drawPane=document.createElementNS(mxConstants.NS_SVG,
...
d;g==1&&(g=Math.floor(c-1)/c);h==1&&(h=Math.floor(d-1)/d);g=g>h?g:h;c=c*g;d=d*g;g=Math.ceil(c)*Math.ceil(d);f++;if(f>10)break}return e*c/b*0.99999},show:function(a,b,c,d){c=c!=null?c:0;d=d!=null?d:0;b==null?b=window.open().document:b.open();document.documentMode==9&&b.writeln('<\!--[if IE]><meta http-equiv="X-UA-Compatible" content="IE=9"><![endif]--\>');var e=a.getGraphBounds(),c=-e.x+c,d=-e.y+d;if(mxClient.IS_IE){for(var e="<html><head>",f=document.getElementsByTagName("base"),g=0;g<f.length;g++)e=
e+f[g].outerHTML;e=e+"<style>";for(g=0;g<document.styleSheets.length;g++)try{e=e+document.styleSheets(g).cssText}catch(h){}e=e+"</style></head><body>"+a.container.innerHTML;b.writeln(e+"</body><html>");b.close();a=b.body.getElementsByTagName("DIV")[0];if(a!=null){a.style.position="absolute";a.style.left=c+"px";a.style.top=d+"px"}}else{b.writeln("<html");b.writeln("<head>");f=document.getElementsByTagName("base");for(g=0;g<f.length;g++)b.writeln(mxUtils.getOuterHtml(f[g]));f=document.getElementsByTagName("link");
for(g=0;g<f.length;g++)b.writeln(mxUtils.getOuterHtml(f[g]));f=document.getElementsByTagName("style");for(g=0;g<f.length;g++)b.writeln(mxUtils.getOuterHtml(f[g]));b.writeln("</head>");b.writeln("</html>");b.close();b.body==null&&b.documentElement.appendChild(b.createElement("body"));b.body.style.overflow="auto";for(a=a.container.firstChild;a!=null;){g=a.cloneNode(true);b.body.appendChild(g);a=a.nextSibling}a=b.getElementsByTagName("g")[0];if(a!=null){a.setAttribute("transform","translate("+c+","+
d+")");c=a.ownerSVGElement;c.setAttribute("width",e.width+Math.max(e.x,0)+3);c.setAttribute("height",e.height+Math.max(e.y,0)+3)}}mxUtils.removeCursors(b.body);return b},printScreen:function(a){var b=window.open();mxUtils.show(a,b.document);a=function(){b.focus();b.print();b.close()};mxClient.IS_GC?b.setTimeout(a,500):a()},popup:function(a,b){if(b){var c=document.createElement("div");c.style.overflow="scroll";c.style.width="636px";c.style.height="460px";var d=document.createElement("pre");d.innerHTML=
mxUtils.htmlEntities(a,false).replace(/\n/g,"<br>").replace(/ /g,"&nbsp;");c.appendChild(d);c=new mxWindow("Popup Window",c,document.body.clientWidth/2-320,(document.body.clientHeight||document.documentElement.clientHeight)/2-240,640,480,false,true);c.setClosable(true);c.setVisible(true)}else if(mxClient.IS_NS){c=window.open();c.document.writeln("<pre>"+mxUtils.htmlEntities(a)+"</pre");c.document.close()}else{c=window.open();d=c.document.createElement("pre");d.innerHTML=mxUtils.htmlEntities(a,false).replace(/\n/g,
...
e.appendChild(document.createTextNode("\u00a0"));mxUtils.write(e,a);var a=document.body.clientWidth,d=document.body.clientHeight||document.documentElement.clientHeight,g=new mxWindow(mxResources.get(mxUtils.errorResource)||mxUtils.errorResource,e,(a-b)/2,d/4,b,null,false,true);if(c){mxUtils.br(e);b=document.createElement("p");c=document.createElement("button");mxClient.IS_IE?c.style.cssText="float:right":c.setAttribute("style","float:right");mxEvent.addListener(c,"click",function(){g.destroy()});
mxUtils.write(c,mxResources.get(mxUtils.closeResource)||mxUtils.closeResource);b.appendChild(c);e.appendChild(b);mxUtils.br(e);g.setClosable(true)}g.setVisible(true);return g},makeDraggable:function(a,b,c,d,e,f,g,h,k,i){a=new mxDragSource(a,c);a.dragOffset=new mxPoint(e!=null?e:0,f!=null?f:mxConstants.TOOLTIP_VERTICAL_OFFSET);a.autoscroll=g;a.setGuidesEnabled(false);if(k!=null)a.highlightDropTargets=k;if(i!=null)a.getDropTarget=i;a.getGraphForEvent=function(a){return typeof b=="function"?b(a):b};
if(d!=null){a.createDragElement=function(){return d.cloneNode(true)};if(h)a.createPreviewElement=function(a){var b=d.cloneNode(true),c=parseInt(b.style.width),e=parseInt(b.style.height);b.style.width=Math.round(c*a.view.scale)+"px";b.style.height=Math.round(e*a.view.scale)+"px";return b}}return a}},mxConstants={DEFAULT_HOTSPOT:0.3,MIN_HOTSPOT_SIZE:8,MAX_HOTSPOT_SIZE:0,RENDERING_HINT_EXACT:"exact",RENDERING_HINT_FASTER:"faster",RENDERING_HINT_FASTEST:"fastest",DIALECT_SVG:"svg",DIALECT_VML:"vml",DIALECT_MIXEDHTML:"mixedHtml",
DIALECT_PREFERHTML:"preferHtml",DIALECT_STRICTHTML:"strictHtml",NS_SVG:"http://www.w3.org/2000/svg",NS_XHTML:"http://www.w3.org/1999/xhtml",NS_XLINK:"http://www.w3.org/1999/xlink",SHADOWCOLOR:"gray",SHADOW_OFFSET_X:2,SHADOW_OFFSET_Y:3,SHADOW_OPACITY:1,NODETYPE_ELEMENT:1,NODETYPE_ATTRIBUTE:2,NODETYPE_TEXT:3,NODETYPE_CDATA:4,NODETYPE_ENTITY_REFERENCE:5,NODETYPE_ENTITY:6,NODETYPE_PROCESSING_INSTRUCTION:7,NODETYPE_COMMENT:8,NODETYPE_DOCUMENT:9,NODETYPE_DOCUMENTTYPE:10,NODETYPE_DOCUMENT_FRAGMENT:11,NODETYPE_NOTATION:12,
...
DEFAULT_STARTSIZE:40,DEFAULT_MARKERSIZE:6,DEFAULT_IMAGESIZE:24,ENTITY_SEGMENT:30,RECTANGLE_ROUNDING_FACTOR:0.15,LINE_ARCSIZE:20,ARROW_SPACING:10,ARROW_WIDTH:30,ARROW_SIZE:30,PAGE_FORMAT_A4_PORTRAIT:new mxRectangle(0,0,826,1169),PAGE_FORMAT_A4_LANDSCAPE:new mxRectangle(0,0,1169,826),PAGE_FORMAT_LETTER_PORTRAIT:new mxRectangle(0,0,850,1100),PAGE_FORMAT_LETTER_LANDSCAPE:new mxRectangle(0,0,1100,850),NONE:"none",STYLE_PERIMETER:"perimeter",STYLE_SOURCE_PORT:"sourcePort",STYLE_TARGET_PORT:"targetPort",
STYLE_PORT_CONSTRAINT:"portConstraint",STYLE_OPACITY:"opacity",STYLE_TEXT_OPACITY:"textOpacity",STYLE_OVERFLOW:"overflow",STYLE_ORTHOGONAL:"orthogonal",STYLE_EXIT_X:"exitX",STYLE_EXIT_Y:"exitY",STYLE_EXIT_PERIMETER:"exitPerimeter",STYLE_ENTRY_X:"entryX",STYLE_ENTRY_Y:"entryY",STYLE_ENTRY_PERIMETER:"entryPerimeter",STYLE_WHITE_SPACE:"whiteSpace",STYLE_ROTATION:"rotation",STYLE_FILLCOLOR:"fillColor",STYLE_GRADIENTCOLOR:"gradientColor",STYLE_GRADIENT_DIRECTION:"gradientDirection",STYLE_STROKECOLOR:"strokeColor",
STYLE_SEPARATORCOLOR:"separatorColor",STYLE_STROKEWIDTH:"strokeWidth",STYLE_ALIGN:"align",STYLE_VERTICAL_ALIGN:"verticalAlign",STYLE_LABEL_POSITION:"labelPosition",STYLE_VERTICAL_LABEL_POSITION:"verticalLabelPosition",STYLE_IMAGE_ASPECT:"imageAspect",STYLE_IMAGE_ALIGN:"imageAlign",STYLE_IMAGE_VERTICAL_ALIGN:"imageVerticalAlign",STYLE_GLASS:"glass",STYLE_IMAGE:"image",STYLE_IMAGE_WIDTH:"imageWidth",STYLE_IMAGE_HEIGHT:"imageHeight",STYLE_IMAGE_BACKGROUND:"imageBackground",STYLE_IMAGE_BORDER:"imageBorder",
STYLE_IMAGE_FLIPH:"imageFlipH",STYLE_IMAGE_FLIPV:"imageFlipV",STYLE_STENCIL_FLIPH:"stencilFlipH",STYLE_STENCIL_FLIPV:"stencilFlipV",STYLE_NOLABEL:"noLabel",STYLE_NOEDGESTYLE:"noEdgeStyle",STYLE_LABEL_BACKGROUNDCOLOR:"labelBackgroundColor",STYLE_LABEL_BORDERCOLOR:"labelBorderColor",STYLE_LABEL_PADDING:"labelPadding",STYLE_INDICATOR_SHAPE:"indicatorShape",STYLE_INDICATOR_IMAGE:"indicatorImage",STYLE_INDICATOR_COLOR:"indicatorColor",STYLE_INDICATOR_STROKECOLOR:"indicatorStrokeColor",STYLE_INDICATOR_GRADIENTCOLOR:"indicatorGradientColor",
STYLE_INDICATOR_SPACING:"indicatorSpacing",STYLE_INDICATOR_WIDTH:"indicatorWidth",STYLE_INDICATOR_HEIGHT:"indicatorHeight",STYLE_INDICATOR_DIRECTION:"indicatorDirection",STYLE_SHADOW:"shadow",STYLE_SEGMENT:"segment",STYLE_ENDARROW:"endArrow",STYLE_STARTARROW:"startArrow",STYLE_ENDSIZE:"endSize",STYLE_STARTSIZE:"startSize",STYLE_ENDFILL:"endFill",STYLE_STARTFILL:"startFill",STYLE_DASHED:"dashed",STYLE_DASH_PATTERN:"dashPattern",STYLE_ROUNDED:"rounded",STYLE_CURVED:"curved",STYLE_ARCSIZE:"arcSize",
STYLE_SMOOTH:"smooth",STYLE_SOURCE_PERIMETER_SPACING:"sourcePerimeterSpacing",STYLE_TARGET_PERIMETER_SPACING:"targetPerimeterSpacing",STYLE_PERIMETER_SPACING:"perimeterSpacing",STYLE_SPACING:"spacing",STYLE_SPACING_TOP:"spacingTop",STYLE_SPACING_LEFT:"spacingLeft",STYLE_SPACING_BOTTOM:"spacingBottom",STYLE_SPACING_RIGHT:"spacingRight",STYLE_HORIZONTAL:"horizontal",STYLE_DIRECTION:"direction",STYLE_ELBOW:"elbow",STYLE_FONTCOLOR:"fontColor",STYLE_FONTFAMILY:"fontFamily",STYLE_FONTSIZE:"fontSize",STYLE_FONTSTYLE:"fontStyle",
STYLE_AUTOSIZE:"autosize",STYLE_FOLDABLE:"foldable",STYLE_EDITABLE:"editable",STYLE_BENDABLE:"bendable",STYLE_MOVABLE:"movable",STYLE_RESIZABLE:"resizable",STYLE_CLONEABLE:"cloneable",STYLE_DELETABLE:"deletable",STYLE_SHAPE:"shape",STYLE_EDGE:"edgeStyle",STYLE_LOOP:"loopStyle",STYLE_ROUTING_CENTER_X:"routingCenterX",STYLE_ROUTING_CENTER_Y:"routingCenterY",FONT_BOLD:1,FONT_ITALIC:2,FONT_UNDERLINE:4,FONT_SHADOW:8,SHAPE_RECTANGLE:"rectangle",SHAPE_ELLIPSE:"ellipse",SHAPE_DOUBLE_ELLIPSE:"doubleEllipse",
...
ALIGN_BOTTOM:"bottom",DIRECTION_NORTH:"north",DIRECTION_SOUTH:"south",DIRECTION_EAST:"east",DIRECTION_WEST:"west",DIRECTION_MASK_NONE:0,DIRECTION_MASK_WEST:1,DIRECTION_MASK_NORTH:2,DIRECTION_MASK_SOUTH:4,DIRECTION_MASK_EAST:8,DIRECTION_MASK_ALL:15,ELBOW_VERTICAL:"vertical",ELBOW_HORIZONTAL:"horizontal",EDGESTYLE_ELBOW:"elbowEdgeStyle",EDGESTYLE_ENTITY_RELATION:"entityRelationEdgeStyle",EDGESTYLE_LOOP:"loopEdgeStyle",EDGESTYLE_SIDETOSIDE:"sideToSideEdgeStyle",EDGESTYLE_TOPTOBOTTOM:"topToBottomEdgeStyle",
...
mxEventObject.prototype.consumed=!1;mxEventObject.prototype.getName=function(){return this.name};mxEventObject.prototype.getProperties=function(){return this.properties};mxEventObject.prototype.getProperty=function(a){return this.properties[a]};mxEventObject.prototype.isConsumed=function(){return this.consumed};mxEventObject.prototype.consume=function(){this.consumed=true};function mxMouseEvent(a,b){this.evt=a;this.state=b}mxMouseEvent.prototype.consumed=!1;mxMouseEvent.prototype.evt=null;
mxMouseEvent.prototype.graphX=null;mxMouseEvent.prototype.graphY=null;mxMouseEvent.prototype.state=null;mxMouseEvent.prototype.getEvent=function(){return this.evt};mxMouseEvent.prototype.getSource=function(){return mxEvent.getSource(this.evt)};mxMouseEvent.prototype.isSource=function(a){if(a!=null)for(var b=this.getSource();b!=null;){if(b==a.node)return true;b=b.parentNode}return false};mxMouseEvent.prototype.getX=function(){return mxEvent.getClientX(this.getEvent())};
...
"mousemove",i=mxClient.IS_TOUCH?"touchend":"mouseup";mxEvent.addListener(a,mxClient.IS_TOUCH?"touchstart":"mousedown",function(a){d!=null?d(a):mxEvent.isConsumed(a)||b.fireMouseEvent(mxEvent.MOUSE_DOWN,new mxMouseEvent(a,h(a)))});mxEvent.addListener(a,k,function(a){e!=null?e(a):mxEvent.isConsumed(a)||b.fireMouseEvent(mxEvent.MOUSE_MOVE,new mxMouseEvent(a,h(a)))});mxEvent.addListener(a,i,function(a){f!=null?f(a):mxEvent.isConsumed(a)||b.fireMouseEvent(mxEvent.MOUSE_UP,new mxMouseEvent(a,h(a)))});mxEvent.addListener(a,
"dblclick",function(a){if(g!=null)g(a);else if(!mxEvent.isConsumed(a)){var c=h(a);b.dblClick(a,c!=null?c.cell:null)}})},release:function(a){if(a!=null){mxEvent.removeAllListeners(a);a=a.childNodes;if(a!=null)for(var b=a.length,c=0;c<b;c=c+1)mxEvent.release(a[c])}},addMouseWheelListener:function(a){if(a!=null){var b=function(b){if(b==null)b=window.event;var d=0,d=mxClient.IS_NS&&!mxClient.IS_SF&&!mxClient.IS_GC?-b.detail/2:b.wheelDelta/120;d!=0&&a(b,d>0)};mxClient.IS_NS?mxEvent.addListener(window,
mxClient.IS_SF||mxClient.IS_GC?"mousewheel":"DOMMouseScroll",b):mxEvent.addListener(document,"mousewheel",b)}},disableContextMenu:function(){return mxClient.IS_IE&&(typeof document.documentMode==="undefined"||document.documentMode<9)?function(a){mxEvent.addListener(a,"contextmenu",function(){return false})}:function(a){a.setAttribute("oncontextmenu","return false;")}}(),getSource:function(a){return a.srcElement!=null?a.srcElement:a.target},isConsumed:function(a){return a.isConsumed!=null&&a.isConsumed},
isLeftMouseButton:function(a){return a.button==(mxClient.IS_IE&&(typeof document.documentMode==="undefined"||document.documentMode<9)?1:0)},isRightMouseButton:function(a){return a.button==2},isPopupTrigger:function(a){return mxEvent.isRightMouseButton(a)||mxEvent.isShiftDown(a)&&!mxEvent.isControlDown(a)},isShiftDown:function(a){return a!=null?a.shiftKey:false},isAltDown:function(a){return a!=null?a.altKey:false},isControlDown:function(a){return a!=null?a.ctrlKey:false},isMetaDown:function(a){return a!=
null?a.metaKey:false},getMainEvent:function(a){(a.type=="touchstart"||a.type=="touchmove")&&a.touches!=null&&a.touches[0]!=null?a=a.touches[0]:a.type=="touchend"&&(a.changedTouches!=null&&a.changedTouches[0]!=null)&&(a=a.changedTouches[0]);return a},getClientX:function(a){return mxEvent.getMainEvent(a).clientX},getClientY:function(a){return mxEvent.getMainEvent(a).clientY},consume:function(a,b,c){c=c!=null?c:true;if(b!=null?b:1)if(a.preventDefault){c&&a.stopPropagation();a.preventDefault()}else if(c)a.cancelBubble=
true;a.isConsumed=true;a.returnValue=false},LABEL_HANDLE:-1,ROTATION_HANDLE:-2,MOUSE_DOWN:"mouseDown",MOUSE_MOVE:"mouseMove",MOUSE_UP:"mouseUp",ACTIVATE:"activate",RESIZE_START:"resizeStart",RESIZE:"resize",RESIZE_END:"resizeEnd",MOVE_START:"moveStart",MOVE:"move",MOVE_END:"moveEnd",PAN_START:"panStart",PAN:"pan",PAN_END:"panEnd",MINIMIZE:"minimize",NORMALIZE:"normalize",MAXIMIZE:"maximize",HIDE:"hide",SHOW:"show",CLOSE:"close",DESTROY:"destroy",REFRESH:"refresh",SIZE:"size",SELECT:"select",FIRED:"fired",
...
this.div.style.top="0px";h=Math.max(document.body.clientHeight||0,document.documentElement.clientHeight||0);if(!mxClient.IS_QUIRKS){this.div.style.width=document.body.clientWidth-2+"px";this.div.style.height=h-2+"px"}this.table.style.width=document.body.clientWidth-2+"px";this.table.style.height=h-2+"px";if(this.resize!=null)this.resize.style.visibility="hidden";if(!mxClient.IS_IE){var h=mxUtils.getCurrentStyle(this.contentWrapper);if(h.overflow=="auto"||this.resize!=null)this.contentWrapper.style.height=
this.div.offsetHeight-this.title.offsetHeight-2+"px"}this.fireEvent(new mxEventObject(mxEvent.MAXIMIZE,"event",f))}mxEvent.consume(f)}});mxEvent.addListener(this.maximize,mxClient.IS_TOUCH?"touchstart":"mousedown",f);mxEvent.addListener(this.title,"dblclick",f)};
...
mxUndoableEdit.prototype.notify=function(){};mxUndoableEdit.prototype.die=function(){};mxUndoableEdit.prototype.undo=function(){if(!this.undone){this.source.fireEvent(new mxEventObject(mxEvent.START_EDIT));for(var a=this.changes.length-1;a>=0;a--){var b=this.changes[a];b.execute!=null?b.execute():b.undo!=null&&b.undo();this.source.fireEvent(new mxEventObject(mxEvent.EXECUTED,"change",b))}this.undone=true;this.redone=false;this.source.fireEvent(new mxEventObject(mxEvent.END_EDIT))}this.notify()};
mxUndoableEdit.prototype.redo=function(){if(!this.redone){this.source.fireEvent(new mxEventObject(mxEvent.START_EDIT));for(var a=this.changes.length,b=0;b<a;b++){var c=this.changes[b];c.execute!=null?c.execute():c.redo!=null&&c.redo();this.source.fireEvent(new mxEventObject(mxEvent.EXECUTED,"change",c))}this.undone=false;this.redone=true;this.source.fireEvent(new mxEventObject(mxEvent.END_EDIT))}this.notify()};function mxUndoManager(a){this.size=a!=null?a:100;this.clear()}
...
mxUndoManager.prototype.undo=function(){for(;this.indexOfNextAdd>0;){var a=this.history[--this.indexOfNextAdd];a.undo();if(a.isSignificant()){this.fireEvent(new mxEventObject(mxEvent.UNDO,"edit",a));break}}};mxUndoManager.prototype.canRedo=function(){return this.indexOfNextAdd<this.history.length};
...
var mxUrlConverter=function(){var a=true,b=null,c=null;return{isEnabled:function(){return a},setEnabled:function(b){a=b},getBaseUrl:function(){return b},setBaseUrl:function(a){b=a},getBaseDomain:function(){return b},setBaseDomain:function(a){b=a},convert:function(d){if(a&&d.substring(0,2)!="//"&&d.indexOf("http://")!=0&&d.indexOf("https://")!=0&&d.indexOf("data:image")!=0){if(b==null){c=location.protocol+"//"+location.host;b=c+location.pathname;var e=b.lastIndexOf("/");e>0&&(b=b.substring(0,e+1))}d=
d.charAt(0)=="/"?c+d:b+d}return d}}};
...
mxMorphing.prototype.cells=null;mxMorphing.prototype.updateAnimation=function(){var a=new mxCellStatePreview(this.graph);if(this.cells!=null)for(var b=0;b<this.cells.length;b++)this.animateCell(this.cells[b],a,false);else this.animateCell(this.graph.getModel().getRoot(),a,true);this.show(a);(a.isEmpty()||this.step++>=this.steps)&&this.stopAnimation()};mxMorphing.prototype.show=function(a){a.show()};
...
c=c.absolutePoints,g=c[0],c=c[c.length-1],h=c.x-g.x,k=c.y-g.y,i=Math.sqrt(h*h+k*k),l=i-2*d-e,e=h/i,k=k/i,i=f*k/3,f=-f*e/3,h=g.x-i/2+d*e,g=g.y-f/2+d*k,m=h+i,n=g+f,o=m+l*e,l=n+l*k,p=o+i,q=l+f,r=p-3*i,u=q-3*f;a.begin();a.moveTo(h,g);a.lineTo(m,n);a.lineTo(o,l);a.lineTo(p,q);a.lineTo(c.x-d*e,c.y-d*k);a.lineTo(r,u);a.lineTo(r+i,u+f);a.close();return true}a.fillAndStroke()}};this.shapes.cylinder={drawShape:function(a,c,d,e){if(e)return false;var c=d.x,e=d.y,f=d.width,d=d.height,g=Math.min(mxCylinder.prototype.maxHeight,
...
h(o));a.appendChild(p)},ellipse:function(b,c,d,f){var g=e.createElement("ellipse");g.setAttribute("x",h(b));g.setAttribute("y",h(c));g.setAttribute("w",h(d));g.setAttribute("h",h(f));a.appendChild(g)},image:function(c,d,f,g,n,o,p,q){var n=b.convert(n),r=e.createElement("image");r.setAttribute("x",h(c));r.setAttribute("y",h(d));r.setAttribute("w",h(f));r.setAttribute("h",h(g));r.setAttribute("src",n);r.setAttribute("aspect",o?"1":"0");r.setAttribute("flipH",p?"1":"0");r.setAttribute("flipV",q?"1":
"0");a.appendChild(r)},text:function(b,c,f,g,n,o,p,q,r,u){if(d){var w=e.createElement("text");w.setAttribute("x",h(b));w.setAttribute("y",h(c));w.setAttribute("w",h(f));w.setAttribute("h",h(g));w.setAttribute("str",n);o!=null&&w.setAttribute("align",o);p!=null&&w.setAttribute("valign",p);w.setAttribute("vertical",q?"1":"0");w.setAttribute("wrap",r?"1":"0");w.setAttribute("format",u);a.appendChild(w)}},begin:function(){a.appendChild(e.createElement("begin"))},moveTo:function(b,c){var d=e.createElement("move");
...
l=q*1.25;m=k-(k>0?q+(h.length-1)*l:h.length*l-1);n==null||n==mxConstants.ALIGN_TOP?d=Math.max(d-3*i.scale,d+m/2+(k>0?l/2-8:0)):n==mxConstants.ALIGN_MIDDLE?d=d+m/2:n==mxConstants.ALIGN_BOTTOM&&(d=Math.min(d,d+m+2*i.scale));d=d+q;for(k=0;k<h.length;k++){n=g("text");n.setAttribute("x",s(c*i.scale));n.setAttribute("y",s(d*i.scale));mxUtils.write(n,h[k]);p.appendChild(n);d=d+q*1.3}}a.appendChild(p)}},begin:function(){n=g("path");o=[];p=null;l=true},moveTo:function(a,b){if(o!=null){a=a+i.dx;b=b+i.dy;o.push("M "+
s(a*i.scale)+" "+s(b*i.scale));d&&(p=new mxPoint(a,b))}},lineTo:function(a,b){if(o!=null){a=a+i.dx;b=b+i.dy;o.push("L "+s(a*i.scale)+" "+s(b*i.scale));if(d){p!=null&&(l&&a!=p.x&&b!=p.y)&&(l=false);p=new mxPoint(a,b)}}},quadTo:function(a,b,c,d){if(o!=null){a=a+i.dx;b=b+i.dy;c=c+i.dx;d=d+i.dy;o.push("Q "+s(a*i.scale)+" "+s(b*i.scale)+" "+s(c*i.scale)+" "+s(d*i.scale));l=false}},curveTo:function(a,b,c,d,e,f){if(o!=null){a=a+i.dx;b=b+i.dy;c=c+i.dx;d=d+i.dy;e=e+i.dx;f=f+i.dy;o.push("C "+s(a*i.scale)+" "+
s(b*i.scale)+" "+s(c*i.scale)+" "+s(d*i.scale)+" "+s(e*i.scale)+" "+s(f*i.scale));l=false}},close:function(){o!=null&&o.push("Z")},stroke:function(){v(n,i,false,true)},fill:function(){v(n,i,true,false)},fillAndStroke:function(){v(n,i,true,true)},shadow:function(a,b){this.save();this.setStrokeColor(a);if(b){this.setFillColor(a);this.fillAndStroke()}else this.stroke();this.restore()},clip:function(){if(n!=null){if(o!=null){n.setAttribute("d",o.join(" "));o=null}var a=++r,b=g("clipPath");b.setAttribute("id",
...
mxGuide.prototype.move=function(a,b,c){if(this.states!=null&&(this.horizontal||this.vertical)&&a!=null&&b!=null){var d=this.graph.getView().translate,e=this.graph.getView().scale,f=b.x,g=b.y,h=false,k=false,i=this.getGuideTolerance(),l=i,m=i,i=a.clone();i.x=i.x+b.x;i.y=i.y+b.y;for(var n=i.x,o=i.x+i.width,p=i.getCenterX(),q=i.y,r=i.y+i.height,u=i.getCenterY(),b=function(b){var b=b+this.graph.panDx,c=false;if(Math.abs(b-p)<l){f=b-a.getCenterX();l=Math.abs(b-p);c=true}else if(Math.abs(b-n)<l){f=b-a.x;
...
b=b-this.graph.panDx;this.guideX.points=[new mxPoint(b,-this.graph.panDy),new mxPoint(b,d.scrollHeight-3-this.graph.panDy)]}h=h||c},i=function(b){var b=b+this.graph.panDy,c=false;if(Math.abs(b-u)<m){g=b-a.getCenterY();m=Math.abs(b-u);c=true}else if(Math.abs(b-q)<m){g=b-a.y;m=Math.abs(b-q);c=true}else if(Math.abs(b-r)<m){g=b-a.y-a.height;m=Math.abs(b-r);c=true}if(c){if(this.guideY==null){this.guideY=this.createGuideShape(false);this.guideY.dialect=this.graph.dialect!=mxConstants.DIALECT_SVG?mxConstants.DIALECT_VML:
mxConstants.DIALECT_SVG;this.guideY.init(this.graph.getView().getOverlayPane());if(this.graph.dialect==mxConstants.DIALECT_SVG){this.guideY.node.setAttribute("pointer-events","none");this.guideY.pipe.setAttribute("pointer-events","none")}}var d=this.graph.container,b=b-this.graph.panDy;this.guideY.points=[new mxPoint(-this.graph.panDx,b),new mxPoint(d.scrollWidth-3-this.graph.panDx,b)]}k=k||c},w=0;w<this.states.length;w++){var v=this.states[w];if(v!=null){if(this.horizontal){b.call(this,v.getCenterX());
b.call(this,v.x);b.call(this,v.x+v.width)}if(this.vertical){i.call(this,v.getCenterY());i.call(this,v.y);i.call(this,v.y+v.height)}}}if(!h&&this.guideX!=null)this.guideX.node.style.visibility="hidden";else if(this.guideX!=null){this.guideX.node.style.visibility="visible";this.guideX.redraw()}if(!k&&this.guideY!=null)this.guideY.node.style.visibility="hidden";else if(this.guideY!=null){this.guideY.node.style.visibility="visible";this.guideY.redraw()}if(c){if(!h){c=a.x-(this.graph.snap(a.x/e-d.x)+d.x)*
...
if(g!=0)c.style.rotation=g}else{if(k||i){var m=1,n=1,o=0,p=0;if(k){m=-1;o=-b.width-2*b.x}if(i){n=-1;p=-b.height-2*b.y}l="scale("+m+" "+n+") translate("+o+" "+p+")"}if(g!=0){k=b.getCenterX();i=b.getCenterY();l=l+(" rotate("+g+" "+k+" "+i+")")}}var q=d==null;if(this.bgNode!=null||this.fgNode!=null){var r=e&&d==null?0:b.x,u=e&&d==null?0:b.y,m=b.width/this.w0,n=b.height/this.h0;this.lastMoveY=this.lastMoveX=0;if(h){n=b.width/this.h0;m=b.height/this.w0;g=(b.width-b.height)/2;r=r+g;u=u-g}if(this.aspect==
"fixed"){m=n=Math.min(m,n);if(h){r=r+(b.height-this.w0*m)/2;u=u+(b.width-this.h0*n)/2}else{r=r+(b.width-this.w0*m)/2;u=u+(b.height-this.h0*n)/2}}if(e){m=m*f;n=n*f;r=r*f;u=u*f}var w=Math.min(m,n),v=[],s=d!=null?d:{fillColorAssigned:false,fill:a.fill,stroke:a.stroke,strokeWidth:this.strokewidth=="inherit"?Number(a.strokewidth)*a.scale:Number(this.strokewidth)*w/(e?f:1),dashed:a.isDashed,dashpattern:[3,3],alpha:a.opacity||1,linejoin:"miter",fontColor:"#000000",fontSize:mxConstants.DEFAULT_FONTSIZE,fontFamily:mxConstants.DEFAULT_FONTFAMILY,
fontStyle:0},t=null,y=null,B=function(b,c){var d=Math.max(1,c.strokeWidth);if(e){b.strokeweight=Math.round(d)+"px";if(c.fill!=null){var d=!c.fillColorAssigned?a.gradient:null,f=document.createElement("v:fill");a.updateVmlFill(f,c.fill,d,a.gradientDirection,c.alpha*100);b.appendChild(f)}else b.filled="false";if(c.stroke!=null){b.stroked="true";b.strokecolor=c.stroke}else b.stroked="false";b.style.position="absolute"}else{b.setAttribute("stroke-width",d);c.alpha!=1&&b.setAttribute("opacity",c.alpha);
c.fill!=null&&c.fillColorAssigned&&b.setAttribute("fill",c.fill);c.stroke!=null&&b.setAttribute("stroke",c.stroke)}},z=function(a){t!=null&&y!=null&&y.push(a)},x=function(a){return e?Math.round(a):a},C=function(d){var g=d.nodeName,h=g=="fill",k=g=="stroke",i=g=="fillstroke";if(g=="save"){v.push(s);s=mxUtils.clone(s)}else if(g=="restore")s=v.pop();else if(g=="path"){y=[];if(e){t=document.createElement("v:shape");B.call(this,t,s);i=Math.round(b.width)*f;g=Math.round(b.height)*f;t.style.width=i+"px";
t.style.height=g+"px";t.coordsize=i+","+g}else{t=document.createElementNS(mxConstants.NS_SVG,"path");B.call(this,t,s);l.length>0&&t.setAttribute("transform",l);d.getAttribute("crisp")=="1"&&t.setAttribute("shape-rendering","crispEdges")}for(d=d.firstChild;d!=null;){d.nodeType==mxConstants.NODETYPE_ELEMENT&&C.call(this,d);d=d.nextSibling}if(e){z("e");t.path=y.join("")}else t.setAttribute("d",y.join(""))}else if(g=="move"){h=e?"m":"M";this.lastMoveX=x(r+Number(d.getAttribute("x"))*m);this.lastMoveY=
x(u+Number(d.getAttribute("y"))*n);z(h+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="line"){h=e?"l":"L";this.lastMoveX=x(r+Number(d.getAttribute("x"))*m);this.lastMoveY=x(u+Number(d.getAttribute("y"))*n);z(h+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="quad")if(e){var h=this.lastMoveX,o=this.lastMoveY,k=r+Number(d.getAttribute("x1"))*m,g=u+Number(d.getAttribute("y1"))*n,i=r+Number(d.getAttribute("x2"))*m,d=u+Number(d.getAttribute("y2"))*n,o=o+2/3*(g-o),p=i+2/3*(k-i),g=d+2/3*(g-d);z("c "+
Math.round(h+2/3*(k-h))+" "+Math.round(o)+" "+Math.round(p)+" "+Math.round(g)+" "+Math.round(i)+" "+Math.round(d));this.lastMoveX=i;this.lastMoveY=d}else{this.lastMoveX=r+Number(d.getAttribute("x2"))*m;this.lastMoveY=u+Number(d.getAttribute("y2"))*n;z("Q "+(r+Number(d.getAttribute("x1"))*m)+" "+(u+Number(d.getAttribute("y1"))*n)+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="curve"){h=e?"c":"C";this.lastMoveX=x(r+Number(d.getAttribute("x3"))*m);this.lastMoveY=x(u+Number(d.getAttribute("y3"))*
n);z(h+" "+x(r+Number(d.getAttribute("x1"))*m)+" "+x(u+Number(d.getAttribute("y1"))*n)+" "+x(r+Number(d.getAttribute("x2"))*m)+" "+x(u+Number(d.getAttribute("y2"))*n)+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="close")z(e?"x":"Z");else if(g=="rect"||g=="roundrect"){o=g=="roundrect";k=x(r+Number(d.getAttribute("x"))*m);h=x(u+Number(d.getAttribute("y"))*n);i=x(Number(d.getAttribute("w"))*m);g=x(Number(d.getAttribute("h"))*n);p=d.getAttribute("arcsize");p==0&&(p=mxConstants.RECTANGLE_ROUNDING_FACTOR*
100);if(e){t=document.createElement(o?"v:roundrect":"v:rect");t.style.left=k+"px";t.style.top=h+"px";t.style.width=i+"px";t.style.height=g+"px";o&&t.setAttribute("arcsize",""+p+"%")}else{t=document.createElementNS(mxConstants.NS_SVG,"rect");t.setAttribute("x",k);t.setAttribute("y",h);t.setAttribute("width",i);t.setAttribute("height",g);if(o){h=Number(p)/100;h=Math.min(i*h,g*h);t.setAttribute("rx",h);t.setAttribute("ry",h)}l.length>0&&t.setAttribute("transform",l);d.getAttribute("crisp")=="1"&&t.setAttribute("shape-rendering",
"crispEdges")}B.call(this,t,s)}else if(g=="ellipse"){k=x(r+Number(d.getAttribute("x"))*m);h=x(u+Number(d.getAttribute("y"))*n);i=x(Number(d.getAttribute("w"))*m);g=x(Number(d.getAttribute("h"))*n);if(e){t=document.createElement("v:arc");t.startangle="0";t.endangle="360";t.style.left=k+"px";t.style.top=h+"px";t.style.width=i+"px";t.style.height=g+"px"}else{t=document.createElementNS(mxConstants.NS_SVG,"ellipse");t.setAttribute("cx",k+i/2);t.setAttribute("cy",h+g/2);t.setAttribute("rx",i/2);t.setAttribute("ry",
g/2);l.length>0&&t.setAttribute("transform",l)}B.call(this,t,s)}else if(g=="arc"){var i=Number(d.getAttribute("rx"))*m,g=Number(d.getAttribute("ry"))*n,o=Number(d.getAttribute("x-axis-rotation")),p=Number(d.getAttribute("large-arc-flag")),A=Number(d.getAttribute("sweep-flag")),k=r+Number(d.getAttribute("x"))*m,h=u+Number(d.getAttribute("y"))*n;if(e){h=mxUtils.arcToCurves(this.lastMoveX,this.lastMoveY,i,g,o,p,A,k,h);for(d=0;d<h.length;d=d+6){z("c "+Math.round(h[d])+" "+Math.round(h[d+1])+" "+Math.round(h[d+
2])+" "+Math.round(h[d+3])+" "+Math.round(h[d+4])+" "+Math.round(h[d+5]));this.lastMoveX=h[d+4];this.lastMoveY=h[d+5]}}else{z("A "+i+","+g+" "+o+" "+p+","+A+" "+k+","+h);this.lastMoveX=r+k;this.lastMoveY=u+h}}else if(g=="image"){o=this.evaluateAttribute(d,"src",a.state);if(o!=null){k=x(r+Number(d.getAttribute("x"))*m);h=x(u+Number(d.getAttribute("y"))*n);i=x(Number(d.getAttribute("w"))*m);g=x(Number(d.getAttribute("h"))*n);p=d.getAttribute("flipH")=="1";A=d.getAttribute("flipV")=="1";if(e){t=document.createElement("v:image");
t.style.filter="alpha(opacity="+s.alpha+")";t.style.left=k+"px";t.style.top=h+"px";t.style.width=i+"px";t.style.height=g+"px";t.src=o;if(p&&A)t.style.rotation="180";else if(p)t.style.flip="x";else if(A)t.style.flip="y"}else{t=document.createElementNS(mxConstants.NS_SVG,"image");t.setAttributeNS(mxConstants.NS_XLINK,"xlink:href",o);t.setAttribute("opacity",s.alpha/100);t.setAttribute("x",k);t.setAttribute("y",h);t.setAttribute("width",i);t.setAttribute("height",g);t.setAttribute("preserveAspectRatio",
"none");if(p||A){var D=1,E=1,o=d=0;if(p){D=-1;d=-i-2*k}if(A){E=-1;o=-g-2*h}t.setAttribute("transform",l+"scale("+D+" "+E+") translate("+d+" "+o+") ")}else t.setAttribute("transform",l)}c.appendChild(t)}}else if(g=="include-shape"){o=mxStencilRegistry.getStencil(d.getAttribute("name"));if(o!=null){k=r+Number(d.getAttribute("x"))*m;h=u+Number(d.getAttribute("y"))*n;i=Number(d.getAttribute("w"))*m;g=Number(d.getAttribute("h"))*n;o.renderDom(a,new mxRectangle(k,h,i,g),c,s)}}else if(g=="text"){i=this.evaluateTextAttribute(d,
"str",a.state);if(i!=null){k=x(r+Number(d.getAttribute("x"))*m);h=x(u+Number(d.getAttribute("y"))*n);g=d.getAttribute("align")||"left";o=d.getAttribute("valign")||"top";if(e){t=document.createElement("v:shape");t.style.position="absolute";t.style.width="1px";t.style.height="1px";t.style.left=k+"px";t.style.top=h+"px";d=document.createElement("v:fill");d.color=s.fontColor;d.on="true";t.appendChild(d);d=document.createElement("v:stroke");d.on="false";t.appendChild(d);d=document.createElement("v:path");
d.textpathok="true";d.v="m "+k+" "+h+" l "+(k+1)+" "+h;t.appendChild(d);d=document.createElement("v:textpath");d.style.cssText="v-text-align:"+g;d.style.fontSize=Math.round(s.fontSize/f)+"px";d.style.fontFamily=s.fontFamily;d.string=i;d.on="true";if((s.fontStyle&mxConstants.FONT_BOLD)==mxConstants.FONT_BOLD)d.style.fontWeight="bold";if((s.fontStyle&mxConstants.FONT_ITALIC)==mxConstants.FONT_ITALIC)d.style.fontStyle="italic";if((s.fontStyle&mxConstants.FONT_UNDERLINE)==mxConstants.FONT_UNDERLINE)d.style.textDecoration=
"underline";if(o=="top")t.style.top=h+s.fontSize/2+"px";else if(o=="bottom")t.style.top=h-s.fontSize/3+"px";t.appendChild(d)}else{t=document.createElementNS(mxConstants.NS_SVG,"text");t.setAttribute("fill",s.fontColor);t.setAttribute("font-family",s.fontFamily);t.setAttribute("font-size",s.fontSize);t.setAttribute("stroke","none");t.setAttribute("x",k);t.appendChild(document.createTextNode(i));(s.fontStyle&mxConstants.FONT_BOLD)==mxConstants.FONT_BOLD&&t.setAttribute("font-weight","bold");(s.fontStyle&
mxConstants.FONT_ITALIC)==mxConstants.FONT_ITALIC&&t.setAttribute("font-style","italic");(s.fontStyle&mxConstants.FONT_UNDERLINE)==mxConstants.FONT_UNDERLINE&&t.setAttribute("text-decoration",uline);g=="left"?g="start":g=="center"?g="middle":g=="right"&&(g="end");t.setAttribute("text-anchor",g);if(o=="top"){t.setAttribute("y",h+s.fontSize/5);t.setAttribute("dy","1ex")}else if(o=="middle"){t.setAttribute("y",h+s.fontSize/8);t.setAttribute("dy","0.5ex")}else t.setAttribute("y",h);l.length>0&&t.setAttribute("transform",
l)}c.appendChild(t)}}else if(h||k||i){if(t!=null){g=null;if(s.dashed){g=e?w:Number(t.getAttribute("stroke-width"));o=[];for(d=0;d<s.dashpattern.length;d++)o.push(Math.max(1,Math.round(Number(s.dashpattern[d])*g)));g=o.join(" ")}if(k||i)if(e){d=document.createElement("v:stroke");d.endcap=s.linecap||"flat";d.joinstyle=s.linejoin||"miter";d.miterlimit=s.miterlimit||"10";t.appendChild(d);if(g!=null)d.dashstyle=g}else{s.linejoin!=null&&t.setAttribute("stroke-linejoin",s.linejoin);if(s.linecap!=null){d=
s.linecap;d=="flat"&&(d="butt");t.setAttribute("stroke-linecap",d)}s.miterlimit!=null&&t.setAttribute("stroke-miterlimit",s.miterlimit);g!=null&&t.setAttribute("stroke-dasharray",g)}if(q&&a.isShadow){d=mxConstants.SHADOW_OFFSET_X*a.scale;o=mxConstants.SHADOW_OFFSET_Y*a.scale;if(e){p=document.createElement("v:shadow");p.setAttribute("on","true");p.setAttribute("color",mxConstants.SHADOWCOLOR);p.setAttribute("offset",Math.round(d)+"px,"+Math.round(o)+"px");p.setAttribute("opacity",mxConstants.SHADOW_OPACITY*
100+"%");d=document.createElement("v:stroke");d.endcap=s.linecap||"flat";d.joinstyle=s.linejoin||"miter";d.miterlimit=s.miterlimit||"10";if(g!=null)d.dashstyle=g;p.appendChild(d);t.appendChild(p)}else{p=t.cloneNode(true);p.setAttribute("stroke",mxConstants.SHADOWCOLOR);s.fill!=null&&(h||i)?p.setAttribute("fill",mxConstants.SHADOWCOLOR):p.setAttribute("fill","none");p.setAttribute("transform","translate("+d+" "+o+") "+(p.getAttribute("transform")||""));p.setAttribute("opacity",mxConstants.SHADOW_OPACITY);
c.appendChild(p)}}if(h)e?t.stroked="false":t.setAttribute("stroke","none");else if(k)e?t.filled="false":t.setAttribute("fill","none");c.appendChild(t)}q&&(q=false)}else if(g=="linecap")s.linecap=d.getAttribute("cap");else if(g=="linejoin")s.linejoin=d.getAttribute("join");else if(g=="miterlimit")s.miterlimit=d.getAttribute("limit");else if(g=="dashed")s.dashed=d.getAttribute("dashed")=="1";else if(g=="dashpattern"){d=d.getAttribute("pattern");if(d!=null&&d.length>0)s.dashpattern=d.split(" ")}else if(g==
"strokewidth"){h=d.getAttribute("fixed")=="1"?1:w;s.strokeWidth=d.getAttribute("width")*h;if(e)s.strokeWidth=s.strokeWidth/f}else if(g=="strokecolor")s.stroke=d.getAttribute("color");else if(g=="fillcolor"){s.fill=d.getAttribute("color");s.fillColorAssigned=true}else if(g=="alpha")s.alpha=Number(d.getAttribute("alpha"));else if(g=="fontcolor")s.fontColor=d.getAttribute("color");else if(g=="fontsize")s.fontSize=Number(d.getAttribute("size"))*w;else if(g=="fontfamily")s.fontFamily=d.getAttribute("family");
else if(g=="fontstyle")s.fontStyle=Number(d.getAttribute("style"))};if(!e){d=document.createElementNS(mxConstants.NS_SVG,"rect");d.setAttribute("x",b.x);d.setAttribute("y",b.y);d.setAttribute("width",b.width);d.setAttribute("height",b.height);d.setAttribute("fill","none");d.setAttribute("stroke","none");c.appendChild(d)}if(this.bgNode!=null)for(d=this.bgNode.firstChild;d!=null;){d.nodeType==mxConstants.NODETYPE_ELEMENT&&C.call(this,d);d=d.nextSibling}else q=false;if(this.fgNode!=null)for(d=this.fgNode.firstChild;d!=
null;){d.nodeType==mxConstants.NODETYPE_ELEMENT&&C.call(this,d);d=d.nextSibling}}};
...
mxSwimlane.prototype.redrawHtml=function(){this.updateHtmlShape(this.node);this.node.style.background="";this.node.style.backgroundColor="";this.startSize=parseInt(mxUtils.getValue(this.style,mxConstants.STYLE_STARTSIZE,mxConstants.DEFAULT_STARTSIZE))*this.scale;this.updateHtmlShape(this.label);this.label.style.top="0px";this.label.style.left="0px";if(mxUtils.getValue(this.style,mxConstants.STYLE_HORIZONTAL,true)){var a=Math.round(this.startSize);this.startSize=Math.min(a,Math.round(this.bounds.height));
this.label.style.height=this.startSize+"px";this.updateHtmlShape(this.content);this.content.style.background="";this.content.style.backgroundColor="";this.content.style.top=a+"px";this.content.style.left="0px";this.content.style.height=Math.max(1,this.bounds.height-a)+"px";if(this.separator!=null){this.separator.style.left=Math.round(this.bounds.width)+"px";this.separator.style.top=Math.round(a)+"px";this.separator.style.width="1px";this.separator.style.height=Math.round(this.bounds.height)+"px";
this.separator.style.borderWidth=Math.round(this.scale)+"px"}if(this.imageNode!=null){this.imageNode.style.left=this.bounds.width-this.imageSize-4+"px";this.imageNode.style.top="0px";this.imageNode.style.width=Math.round(this.imageSize*this.scale)+"px";this.imageNode.style.height=Math.round(this.imageSize*this.scale)+"px"}}else{a=Math.round(this.startSize);this.startSize=Math.min(this.startSize,Math.round(this.bounds.width));this.label.style.width=this.startSize+"px";this.updateHtmlShape(this.content);
this.content.style.background="";this.content.style.backgroundColor="";this.content.style.top="0px";this.content.style.left=a+"px";this.content.style.width=Math.max(0,this.bounds.width-a)+"px";if(this.separator!=null){this.separator.style.left=this.startSize+"px";this.separator.style.top=Math.round(this.bounds.height)+"px";this.separator.style.width=Math.round(this.bounds.width)+"px";this.separator.style.height="1px";this.separator.style.borderWidth=Math.round(this.scale)+"px"}if(this.imageNode!=
null){this.imageNode.style.left=this.bounds.width-this.imageSize-4+"px";this.imageNode.style.top="0px";this.imageNode.style.width=this.imageSize*this.scale+"px";this.imageNode.style.height=this.imageSize*this.scale+"px"}}};
...
mxCompactTreeLayout.prototype.moveTree=!1;mxCompactTreeLayout.prototype.levelDistance=10;mxCompactTreeLayout.prototype.nodeDistance=20;mxCompactTreeLayout.prototype.resetEdges=!0;mxCompactTreeLayout.prototype.prefHozEdgeSep=5;mxCompactTreeLayout.prototype.prefVertEdgeOff=4;mxCompactTreeLayout.prototype.minEdgeJetty=8;mxCompactTreeLayout.prototype.channelBuffer=4;mxCompactTreeLayout.prototype.edgeRouting=!0;mxCompactTreeLayout.prototype.sortEdges=!1;
...
mxFastOrganicLayout.prototype.calcPositions=function(){for(var a=0;a<this.vertexArray.length;a++)if(this.isMoveable[a]){var b=Math.sqrt(this.dispX[a]*this.dispX[a]+this.dispY[a]*this.dispY[a]);b<0.001&&(b=0.001);var c=this.dispX[a]/b*Math.min(b,this.temperature),b=this.dispY[a]/b*Math.min(b,this.temperature);this.dispX[a]=0;this.dispY[a]=0;this.cellLocation[a][0]=this.cellLocation[a][0]+c;this.cellLocation[a][1]=this.cellLocation[a][1]+b}};
...
mxParallelEdgeLayout.prototype.findParallels=function(a){for(var b=this.graph.getModel(),c=[],d=b.getChildCount(a),e=0;e<d;e++){var f=b.getChildAt(a,e);if(!this.isEdgeIgnored(f)){var g=this.getEdgeId(f);if(g!=null){c[g]==null&&(c[g]=[]);c[g].push(f)}}}return c};mxParallelEdgeLayout.prototype.getEdgeId=function(a){var b=this.graph.getView(),c=b.getVisibleTerminal(a,true),a=b.getVisibleTerminal(a,false);if(c!=null&&a!=null){c=mxCellPath.create(c);a=mxCellPath.create(a);return c>a?a+"-"+c:c+"-"+a}return null};
mxParallelEdgeLayout.prototype.layout=function(a){var b=a[0],c=this.graph.getView(),d=this.graph.getModel(),e=d.getGeometry(c.getVisibleTerminal(b,true)),d=d.getGeometry(c.getVisibleTerminal(b,false));if(e==d)for(var b=e.x+e.width+this.spacing,c=e.y+e.height/2,f=0;f<a.length;f++){this.route(a[f],b,c);b=b+this.spacing}else if(e!=null&&d!=null){var b=e.x+e.width/2,c=e.y+e.height/2,f=d.x+d.width/2-b,g=d.y+d.height/2-c,d=Math.sqrt(f*f+g*g);if(d>0){e=g*this.spacing/d;d=f*this.spacing/d;b=b+f/2+e*(a.length-
1)/2;c=c+g/2-d*(a.length-1)/2;for(f=0;f<a.length;f++){this.route(a[f],b,c);b=b-e;c=c+d}}}};mxParallelEdgeLayout.prototype.route=function(a,b,c){this.graph.isCellMovable(a)&&this.setEdgePoints(a,[new mxPoint(b,c)])};function mxCompositeLayout(a,b,c){mxGraphLayout.call(this,a);this.layouts=b;this.master=c}mxCompositeLayout.prototype=new mxGraphLayout;mxCompositeLayout.prototype.constructor=mxCompositeLayout;mxCompositeLayout.prototype.layouts=null;mxCompositeLayout.prototype.master=null;
...
mxGraphHierarchyEdge.prototype.isReversed=!1;mxGraphHierarchyEdge.prototype.invert=function(){var a=this.source;this.source=this.target;this.target=a;this.isReversed=!this.isReversed};
...
function mxGraphHierarchyModel(a,b,c,d,e){a.getGraph();this.tightenToSource=e;this.roots=c;this.parent=d;this.vertexMapper=new mxDictionary;this.edgeMapper=new mxDictionary;this.maxRank=0;c=[];b==null&&(b=this.graph.getChildVertices(d));this.maxRank=this.SOURCESCANSTARTRANK;this.createInternalCells(a,b,c);for(d=0;d<b.length;d++){for(var e=c[d].connectsAsSource,f=0;f<e.length;f++){var g=e[f],h=g.edges;if(h!=null&&h.length>0){var h=h[0],k=a.getVisibleTerminal(h,false),k=this.vertexMapper.get(k);if(c[d]==
k){k=a.getVisibleTerminal(h,true);k=this.vertexMapper.get(k)}if(k!=null&&c[d]!=k){g.target=k;if(k.connectsAsTarget.length==0)k.connectsAsTarget=[];mxUtils.indexOf(k.connectsAsTarget,g)<0&&k.connectsAsTarget.push(g)}}}c[d].temp[0]=1}}mxGraphHierarchyModel.prototype.maxRank=null;mxGraphHierarchyModel.prototype.vertexMapper=null;mxGraphHierarchyModel.prototype.edgeMapper=null;mxGraphHierarchyModel.prototype.ranks=null;mxGraphHierarchyModel.prototype.roots=null;
...
mxGraphHierarchyModel.prototype.createInternalCells=function(a,b,c){for(var d=a.getGraph(),e=0;e<b.length;e++){c[e]=new mxGraphHierarchyNode(b[e]);this.vertexMapper.put(b[e],c[e]);var f=a.getEdges(b[e]);c[e].connectsAsSource=[];for(var g=0;g<f.length;g++){var h=a.getVisibleTerminal(f[g],false);if(h!=b[e]&&a.graph.model.isVertex(h)&&!a.isVertexIgnored(h)){var k=a.getEdgesBetween(b[e],h,false),h=a.getEdgesBetween(b[e],h,true);if(k!=null&&k.length>0&&this.edgeMapper.get(k[0])==null&&h.length*2>=k.length){for(var h=
new mxGraphHierarchyEdge(k),i=0;i<k.length;i++){var l=k[i];this.edgeMapper.put(l,h);d.resetEdge(l);if(a.disableEdgeStyle){a.setEdgeStyleEnabled(l,false);a.setOrthogonalEdge(l,true)}}h.source=c[e];mxUtils.indexOf(c[e].connectsAsSource,h)<0&&c[e].connectsAsSource.push(h)}}}c[e].temp[0]=0}};
mxGraphHierarchyModel.prototype.initialRank=function(){var a=[];if(this.roots!=null)for(var b=0;b<this.roots.length;b++){var c=this.vertexMapper.get(this.roots[b]);c!=null&&a.push(c)}for(var d=this.vertexMapper.getValues(),b=0;b<d.length;b++)d[b].temp[0]=-1;for(var e=a.slice();a.length>0;){var c=a[0],f,g;f=c.connectsAsTarget;g=c.connectsAsSource;for(var h=true,k=this.SOURCESCANSTARTRANK,b=0;b<f.length;b++){var i=f[b];if(i.temp[0]==5270620){i=i.source;k=Math.min(k,i.temp[0]-1)}else{h=false;break}}if(h){c.temp[0]=
k;this.maxRank=Math.min(this.maxRank,k);if(g!=null)for(b=0;b<g.length;b++){i=g[b];i.temp[0]=5270620;i=i.target;if(i.temp[0]==-1){a.push(i);i.temp[0]=-2}}a.shift()}else{b=a.shift();a.push(c);if(b==c&&a.length==1)break}}for(b=0;b<d.length;b++)d[b].temp[0]=d[b].temp[0]-this.maxRank;for(b=0;b<e.length;b++){c=e[b];a=0;f=c.connectsAsSource;for(d=0;d<f.length;d++){i=f[d];i=i.target;c.temp[0]=Math.max(a,i.temp[0]+1);a=c.temp[0]}}this.maxRank=this.SOURCESCANSTARTRANK-this.maxRank};
mxGraphHierarchyModel.prototype.fixRanks=function(){var a=[];this.ranks=[];for(var b=0;b<this.maxRank+1;b++){a[b]=[];this.ranks[b]=a[b]}var c=null;if(this.roots!=null)for(var d=this.roots,c=[],b=0;b<d.length;b++){var e=this.vertexMapper.get(d[b]);c[b]=e}this.visit(function(b,c,d,e,i){if(i==0&&c.maxRank<0&&c.minRank<0){a[c.temp[0]].push(c);c.maxRank=c.temp[0];c.minRank=c.temp[0];c.temp[0]=a[c.maxRank].length-1}if(b!=null&&d!=null&&b.maxRank-c.maxRank>1){d.maxRank=b.maxRank;d.minRank=c.maxRank;d.temp=
...
mxGraphHierarchyModel.prototype.dfs=function(a,b,c,d,e,f){if(b!=null){var g=b.id;if(e[g]==null){e[g]=b;d(a,b,c,f,0);a=b.connectsAsSource.slice();for(c=0;c<a.length;c++){g=a[c];this.dfs(b,g.target,g,d,e,f+1)}}else d(a,b,c,f,1)}};
mxGraphHierarchyModel.prototype.extendedDfs=function(a,b,c,d,e,f,g,h){if(b!=null){if(a!=null&&(b.hashCode==null||b.hashCode[0]!=a.hashCode[0])){f=a.hashCode.length+1;b.hashCode=a.hashCode.slice();b.hashCode[f-1]=g}g=b.id;if(e[g]==null){e[g]=b;d(a,b,c,h,0);a=b.connectsAsSource.slice();for(c=0;c<a.length;c++){g=a[c];this.extendedDfs(b,g.target,g,d,e,b.hashCode,c,h+1)}}else d(a,b,c,h,1)}};function mxHierarchicalLayoutStage(){}mxHierarchicalLayoutStage.prototype.execute=function(){};
...
mxMedianHybridCrossingReduction.prototype.calculateRankCrossing=function(a,b){for(var c=0,d=b.ranks[a],e=b.ranks[a-1],f=[],g=0;g<d.length;g++){for(var h=d[g],k=h.getGeneralPurposeVariable(a),h=h.getPreviousLayerConnectedCells(a),i=[],l=0;l<h.length;l++){var m=h[l].getGeneralPurposeVariable(a-1);i.push(m)}i.sort(function(a,b){return a-b});f[k]=i}d=[];for(g=0;g<f.length;g++)d=d.concat(f[g]);for(f=1;f<e.length;)f=f<<1;k=2*f-1;f=f-1;e=[];for(g=0;g<k;++g)e[g]=0;for(g=0;g<d.length;g++){k=d[g]+f;for(++e[k];k>
0;){k%2&&(c=c+e[k+1]);k=k-1>>1;++e[k]}}return c};
mxMedianHybridCrossingReduction.prototype.transpose=function(a,b){for(var c=true,d=0;c&&d++<10;)for(var e=a%2==1&&d%2==1,c=false,f=0;f<b.ranks.length;f++){for(var g=b.ranks[f],h=[],k=0;k<g.length;k++){var i=g[k],l=i.getGeneralPurposeVariable(f);l<0&&(l=k);h[l]=i}for(var m=l=i=null,n=null,o=null,p=null,q=null,r=null,u=null,w=null,k=0;k<g.length-1;k++){if(k==0){for(var u=h[k],i=u.getNextLayerConnectedCells(f),l=u.getPreviousLayerConnectedCells(f),o=[],p=[],v=0;v<i.length;v++)o[v]=i[v].getGeneralPurposeVariable(f+
1);for(v=0;v<l.length;v++)p[v]=l[v].getGeneralPurposeVariable(f-1)}else{i=m;l=n;o=q;p=r;u=w}w=h[k+1];m=w.getNextLayerConnectedCells(f);n=w.getPreviousLayerConnectedCells(f);q=[];r=[];for(v=0;v<m.length;v++)q[v]=m[v].getGeneralPurposeVariable(f+1);for(v=0;v<n.length;v++)r[v]=n[v].getGeneralPurposeVariable(f-1);for(var s=0,t=0,v=0;v<o.length;v++)for(var y=0;y<q.length;y++){o[v]>q[y]&&s++;o[v]<q[y]&&t++}for(v=0;v<p.length;v++)for(y=0;y<r.length;y++){p[v]>r[y]&&s++;p[v]<r[y]&&t++}if(t<s||t==s&&e){m=u.getGeneralPurposeVariable(f);
u.setGeneralPurposeVariable(f,w.getGeneralPurposeVariable(f));w.setGeneralPurposeVariable(f,m);m=i;n=l;q=o;r=p;w=u;e||(c=true)}}}};mxMedianHybridCrossingReduction.prototype.weightedMedian=function(a,b){var c=a%2==0;if(c)for(var d=b.maxRank-1;d>=0;d--)this.medianRank(d,c);else for(d=1;d<b.maxRank;d++)this.medianRank(d,c)};
...
mxMinimumCycleRemover.prototype.execute=function(){for(var a=this.layout.getModel(),b={},c=a.vertexMapper.getValues(),d={},e=0;e<c.length;e++)d[c[e].id]=c[e];c=null;if(a.roots!=null)for(var f=a.roots,c=[],e=0;e<f.length;e++)c[e]=a.vertexMapper.get(f[e]);a.visit(function(a,c,e){if(c.isAncestor(a)){e.invert();mxUtils.remove(e,a.connectsAsSource);a.connectsAsTarget.push(e);mxUtils.remove(e,c.connectsAsTarget);c.connectsAsSource.push(e)}b[c.id]=c;delete d[c.id]},c,true,null);e=mxUtils.clone(b,null,true);
a.visit(function(a,c,e){if(c.isAncestor(a)){e.invert();mxUtils.remove(e,a.connectsAsSource);c.connectsAsSource.push(e);a.connectsAsTarget.push(e);mxUtils.remove(e,c.connectsAsTarget)}b[c.id]=c;delete d[c.id]},d,true,e)};function mxCoordinateAssignment(a,b,c,d,e,f){this.layout=a;this.intraCellSpacing=b;this.interRankCellSpacing=c;this.orientation=d;this.initialX=e;this.parallelEdgeSpacing=f}var mxHierarchicalEdgeStyle={ORTHOGONAL:1,POLYLINE:2,STRAIGHT:3,CURVE:4};mxCoordinateAssignment.prototype=new mxHierarchicalLayoutStage;
...
mxCoordinateAssignment.prototype.widestRankValue=null;mxCoordinateAssignment.prototype.rankWidths=null;mxCoordinateAssignment.prototype.rankY=null;mxCoordinateAssignment.prototype.fineTuning=!0;mxCoordinateAssignment.prototype.edgeStyle=mxHierarchicalEdgeStyle.POLYLINE;mxCoordinateAssignment.prototype.nextLayerConnectedCache=null;mxCoordinateAssignment.prototype.previousLayerConnectedCache=null;mxCoordinateAssignment.prototype.groupPadding=10;
...
mxCoordinateAssignment.prototype.minNode=function(a){for(var b=[],c=new mxDictionary,d=[],e=0;e<=a.maxRank;e++){d[e]=a.ranks[e];for(var f=0;f<d[e].length;f++){var g=d[e][f],h=new WeightedCellSorter(g,e);h.rankIndex=f;h.visited=true;b.push(h);c.put(g,h)}}a=b.length*10;for(f=0;b.length>0&&f<=a;){var g=b.shift(),e=g.cell,k=g.weightedValue,i=parseInt(g.rankIndex),h=e.getNextLayerConnectedCells(k),l=e.getPreviousLayerConnectedCells(k),m=h.length,n=l.length,o=this.medianXValue(h,k+1),p=this.medianXValue(l,
k-1),q=m+n,r=e.getGeneralPurposeVariable(k),u=r;q>0&&(u=(o*m+p*n)/q);m=false;if(u<r-1)if(i==0){e.setGeneralPurposeVariable(k,u);m=true}else{i=d[k][i-1];r=i.getGeneralPurposeVariable(k);r=r+i.width/2+this.intraCellSpacing+e.width/2;if(r<u){e.setGeneralPurposeVariable(k,u);m=true}else if(r<e.getGeneralPurposeVariable(k)-1){e.setGeneralPurposeVariable(k,r);m=true}}else if(u>r+1)if(i==d[k].length-1){e.setGeneralPurposeVariable(k,u);m=true}else{i=d[k][i+1];r=i.getGeneralPurposeVariable(k);r=r-i.width/
2-this.intraCellSpacing-e.width/2;if(r>u){e.setGeneralPurposeVariable(k,u);m=true}else if(r>e.getGeneralPurposeVariable(k)+1){e.setGeneralPurposeVariable(k,r);m=true}}if(m){for(e=0;e<h.length;e++){k=h[e];k=c.get(k);if(k!=null&&k.visited==false){k.visited=true;b.push(k)}}for(e=0;e<l.length;e++){k=l[e];k=c.get(k);if(k!=null&&k.visited==false){k.visited=true;b.push(k)}}}g.visited=false;f++}};
...
mxCoordinateAssignment.prototype.rankMedianPosition=function(a,b,c){for(var b=b.ranks[a],d=[],e={},f=0;f<b.length;f++){var g=b[f];d[f]=new WeightedCellSorter;d[f].cell=g;d[f].rankIndex=f;e[g.id]=d[f];var h=null,h=c<a?g.getPreviousLayerConnectedCells(a):g.getNextLayerConnectedCells(a);d[f].weightedValue=this.calculatedWeightedValue(g,h)}d.sort(WeightedCellSorter.prototype.compare);for(f=0;f<d.length;f++){var k=0,g=d[f].cell,k=0,h=c<a?g.getPreviousLayerConnectedCells(a).slice():g.getNextLayerConnectedCells(a).slice();
if(h!=null){k=h.length;k=k>0?this.medianXValue(h,c):g.getGeneralPurposeVariable(a)}for(var i=0,h=-1E8,l=d[f].rankIndex-1;l>=0;){var m=e[b[l].id];if(m!=null){var n=m.cell;if(m.visited){h=n.getGeneralPurposeVariable(a)+n.width/2+this.intraCellSpacing+i+g.width/2;l=-1}else{i=i+(n.width+this.intraCellSpacing);l--}}}i=0;n=1E8;for(l=d[f].rankIndex+1;l<d.length;){m=e[b[l].id];if(m!=null){var o=m.cell;if(m.visited){n=o.getGeneralPurposeVariable(a)-o.width/2-this.intraCellSpacing-i-g.width/2;l=d.length}else{i=
i+(o.width+this.intraCellSpacing);l++}}}if(k>=h&&k<=n)g.setGeneralPurposeVariable(a,k);else if(k<h){g.setGeneralPurposeVariable(a,h);this.currentXDelta=this.currentXDelta+(h-k)}else if(k>n){g.setGeneralPurposeVariable(a,n);this.currentXDelta=this.currentXDelta+(k-n)}d[f].visited=true}};mxCoordinateAssignment.prototype.calculatedWeightedValue=function(a,b){for(var c=0,d=0;d<b.length;d++){var e=b[d];a.isVertex()&&e.isVertex()?c++:c=a.isEdge()&&e.isEdge()?c+8:c+2}return c};
mxCoordinateAssignment.prototype.medianXValue=function(a,b){if(a.length==0)return 0;for(var c=[],d=0;d<a.length;d++)c[d]=a[d].getGeneralPurposeVariable(b);c.sort(function(a,b){return a-b});if(a.length%2==1)return c[Math.floor(a.length/2)];d=a.length/2;return(c[d-1]+c[d])/2};
...
mxCoordinateAssignment.prototype.setCellLocations=function(a,b){this.rankTopY=[];this.rankBottomY=[];for(var c=0;c<b.ranks.length;c++){this.rankTopY[c]=Number.MAX_VALUE;this.rankBottomY[c]=-Number.MAX_VALUE}var d=null;this.layout.resizeParent&&(d={});for(var e=b.vertexMapper.getValues(),c=0;c<e.length;c++){this.setVertexLocation(e[c]);if(this.layout.resizeParent){var f=a.model.getParent(e[c].cell),g=mxObjectIdentity.get(f);d[g]==null&&(d[g]=f)}}(this.edgeStyle==mxHierarchicalEdgeStyle.ORTHOGONAL||
this.edgeStyle==mxHierarchicalEdgeStyle.POLYLINE||this.edgeStyle==mxHierarchicalEdgeStyle.CURVE)&&this.localEdgeProcessing(b);e=b.edgeMapper.getValues();for(c=0;c<e.length;c++)this.setEdgePosition(e[c]);this.layout.resizeParent&&d!=null&&this.adjustParents(d)};mxCoordinateAssignment.prototype.adjustParents=function(a){var b=[],c;for(c in a)b.push(a[c]);this.layout.arrangeGroups(mxUtils.sortCells(b,true),this.groupPadding)};
...
p;if(o.isVertex()){p=h==0?e.connectsAsSource:e.connectsAsTarget;for(var q=0;q<p.length;q++)if(p[q].source==o||p[q].target==o){f=f+p[q].edges.length;n++;g.push(p[q])}}else{f=f+o.edges.length;n++;g.push(o)}}if(e.width>(f+1)*this.prefHozEdgeSep+2*this.prefHozEdgeSep){l=l+this.prefHozEdgeSep;m=m-this.prefHozEdgeSep}k=(m-l)/f;l=l+k/2;m=this.minEdgeJetty-this.prefVertEdgeOff;for(i=n=0;i<g.length;i++){o=g[i].edges.length;p=this.jettyPositions[g[i].ids[0]];if(p==null){p=[];this.jettyPositions[g[i].ids[0]]=
...
mxCoordinateAssignment.prototype.setEdgePosition=function(a){var b=0;if(a.temp[0]!=101207){var c=a.maxRank,d=a.minRank;if(c==d){c=a.source.maxRank;d=a.target.minRank}for(var e=0,f=this.jettyPositions[a.ids[0]],g=a.isReversed?a.target.cell:a.source.cell,h=this.layout.graph,k=this.orientation==mxConstants.DIRECTION_EAST||this.orientation==mxConstants.DIRECTION_SOUTH,i=0;i<a.edges.length;i++){var l=a.edges[i],m=this.layout.getVisibleTerminal(l,true),n=[],o=a.isReversed;m!=g&&(o=!o);if(f!=null){var p=
o?2:0,q=o?k?this.rankBottomY[d]:this.rankTopY[d]:k?this.rankTopY[c]:this.rankBottomY[c],r=f[e*4+1+p];o!=k&&(r=-r);var q=q+r,p=f[e*4+p],u=h.model.getTerminal(l,true);if(this.layout.isPort(u)&&h.model.getParent(u)==m){p=h.view.getState(u);p=p!=null?p.x:m.geometry.x+a.source.width*u.geometry.x}if(this.orientation==mxConstants.DIRECTION_NORTH||this.orientation==mxConstants.DIRECTION_SOUTH){n.push(new mxPoint(p,q));this.edgeStyle==mxHierarchicalEdgeStyle.CURVE&&n.push(new mxPoint(p,q+r))}else{n.push(new mxPoint(q,
p));this.edgeStyle==mxHierarchicalEdgeStyle.CURVE&&n.push(new mxPoint(q+r,p))}}p=a.x.length-1;q=r=-1;m=a.maxRank-1;if(o){p=0;r=a.x.length;q=1;m=a.minRank+1}for(;a.maxRank!=a.minRank&&p!=r;p=p+q){var u=a.x[p]+b,w=(this.rankTopY[m]+this.rankBottomY[m+1])/2,v=(this.rankTopY[m-1]+this.rankBottomY[m])/2;if(o)var s=w,w=v,v=s;if(this.orientation==mxConstants.DIRECTION_NORTH||this.orientation==mxConstants.DIRECTION_SOUTH){n.push(new mxPoint(u,w));n.push(new mxPoint(u,v))}else{n.push(new mxPoint(w,u));n.push(new mxPoint(v,
u))}this.limitX=Math.max(this.limitX,u);m=m+q}if(f!=null){p=o?2:0;q=o?k?this.rankTopY[c]:this.rankBottomY[c]:k?this.rankBottomY[d]:this.rankTopY[d];r=f[e*4+3-p];o!=k&&(r=-r);q=q-r;p=f[e*4+2-p];o=h.model.getTerminal(l,false);m=this.layout.getVisibleTerminal(l,false);if(this.layout.isPort(o)&&h.model.getParent(o)==m){p=h.view.getState(o);p=p!=null?p.x:m.geometry.x+a.target.width*o.geometry.x}if(this.orientation==mxConstants.DIRECTION_NORTH||this.orientation==mxConstants.DIRECTION_SOUTH){this.edgeStyle==
mxHierarchicalEdgeStyle.CURVE&&n.push(new mxPoint(p,q-r));n.push(new mxPoint(p,q))}else{this.edgeStyle==mxHierarchicalEdgeStyle.CURVE&&n.push(new mxPoint(q-r,p));n.push(new mxPoint(q,p))}}a.isReversed&&this.processReversedEdge(a,l);this.layout.setEdgePoints(l,n);b=b==0?this.parallelEdgeSpacing:b>0?-b:-b+this.parallelEdgeSpacing;e++}a.temp[0]=101207}};
...
function mxHierarchicalLayout(a,b,c){mxGraphLayout.call(this,a);this.orientation=b!=null?b:mxConstants.DIRECTION_NORTH;this.deterministic=c!=null?c:true}mxHierarchicalLayout.prototype=new mxGraphLayout;mxHierarchicalLayout.prototype.constructor=mxHierarchicalLayout;mxHierarchicalLayout.prototype.roots=null;mxHierarchicalLayout.prototype.resizeParent=!1;mxCompactTreeLayout.prototype.maintainParentLocation=!1;mxHierarchicalLayout.prototype.moveParent=!1;mxHierarchicalLayout.prototype.parentBorder=0;
mxHierarchicalLayout.prototype.intraCellSpacing=30;mxHierarchicalLayout.prototype.interRankCellSpacing=100;mxHierarchicalLayout.prototype.interHierarchySpacing=60;mxHierarchicalLayout.prototype.parallelEdgeSpacing=10;mxHierarchicalLayout.prototype.orientation=mxConstants.DIRECTION_NORTH;mxHierarchicalLayout.prototype.fineTuning=!0;mxHierarchicalLayout.prototype.tightenToSource=!0;mxHierarchicalLayout.prototype.disableEdgeStyle=!0;mxHierarchicalLayout.prototype.traverseAncestors=!0;
mxHierarchicalLayout.prototype.model=null;mxHierarchicalLayout.prototype.edgesCache=null;mxHierarchicalLayout.prototype.edgeSourceTermCache=null;mxHierarchicalLayout.prototype.edgesTargetTermCache=null;mxHierarchicalLayout.prototype.getModel=function(){return this.model};
mxHierarchicalLayout.prototype.execute=function(a,b){this.parent=a;var c=this.graph.model;this.edgesCache=new mxDictionary;this.edgeSourceTermCache=new mxDictionary;this.edgesTargetTermCache=new mxDictionary;b!=null&&!(b instanceof Array)&&(b=[b]);if(!(b==null&&a==null)){this.parentY=this.parentX=null;if(a!=this.root&&c.isVertex(a)!=null&&this.maintainParentLocation){var d=this.graph.getCellGeometry(a);if(d!=null){this.parentX=d.x;this.parentY=d.y}}if(b!=null){for(var e=[],f=0;f<b.length;f++)(a!=
null?c.isAncestor(a,b[f]):1)&&c.isVertex(b[f])&&e.push(b[f]);this.roots=e}c.beginUpdate();try{this.run(a);this.resizeParent&&!this.graph.isCellCollapsed(a)&&this.graph.updateGroupBounds([a],this.parentBorder,this.moveParent);if(this.parentX!=null&&this.parentY!=null){d=this.graph.getCellGeometry(a);if(d!=null){d=d.clone();d.x=this.parentX;d.y=this.parentY;c.setGeometry(a,d)}}}finally{c.endUpdate()}}};
mxHierarchicalLayout.prototype.findRoots=function(a,b){var c=[];if(a!=null&&b!=null){var d=this.graph.model,e=null,f=-1E5,g;for(g in b){var h=b[g];if(d.isVertex(h)&&this.graph.isCellVisible(h)){for(var k=this.getEdges(h),i=0,l=0,m=0;m<k.length;m++)this.getVisibleTerminal(k[m],true)==h?i++:l++;l==0&&i>0&&c.push(h);k=i-l;if(k>f){f=k;e=h}}}c.length==0&&e!=null&&c.push(e)}return c};
mxHierarchicalLayout.prototype.getEdges=function(a){var b=this.edgesCache.get(a);if(b!=null)return b;for(var c=this.graph.model,b=[],d=this.graph.isCellCollapsed(a),e=c.getChildCount(a),f=0;f<e;f++){var g=c.getChildAt(a,f);if(this.isPort(g))b=b.concat(c.getEdges(g,true,true));else if(d||!this.graph.isCellVisible(g))b=b.concat(c.getEdges(g,true,true))}b=b.concat(c.getEdges(a,true,true));c=[];for(f=0;f<b.length;f++){d=this.getVisibleTerminal(b[f],true);e=this.getVisibleTerminal(b[f],false);(d==e||d!=
e&&(e==a&&(this.parent==null||this.graph.isValidAncestor(d,this.parent,this.traverseAncestors))||d==a&&(this.parent==null||this.graph.isValidAncestor(e,this.parent,this.traverseAncestors))))&&c.push(b[f])}this.edgesCache.put(a,c);return c};
mxHierarchicalLayout.prototype.getVisibleTerminal=function(a,b){var c=this.edgesTargetTermCache;if(b)c=this.edgeSourceTermCache;var d=c.get(a);if(d!=null)return d;var d=this.graph.view.getState(a),e=d!=null?d.getVisibleTerminal(b):this.graph.view.getVisibleTerminal(a,b);e==null&&(e=d!=null?d.getVisibleTerminal(b):this.graph.view.getVisibleTerminal(a,b));if(e!=null){this.isPort(e)&&(e=this.graph.model.getParent(e));c.put(a,e)}return e};
mxHierarchicalLayout.prototype.run=function(a){var b=[],c=[];if(this.roots==null&&a!=null){var d={};this.filterDescendants(a,d);this.roots=[];var e=true,f;for(f in d)if(d[f]!=null){e=false;break}for(;!e;){for(var g=this.findRoots(a,d),e=0;e<g.length;e++){var h={};b.push(h);this.traverse(g[e],true,null,c,h,b,d)}for(e=0;e<g.length;e++)this.roots.push(g[e]);e=true;for(f in d)if(d[f]!=null){e=false;break}}}else for(e=0;e<this.roots.length;e++){h={};b.push(h);this.traverse(this.roots[e],true,null,c,h,
...
mxHierarchicalLayout.prototype.getEdgesBetween=function(a,b,c){for(var c=c!=null?c:false,d=this.getEdges(a),e=[],f=0;f<d.length;f++){var g=this.getVisibleTerminal(d[f],true),h=this.getVisibleTerminal(d[f],false);(g==a&&h==b||!c&&g==b&&h==a)&&e.push(d[f])}return e};
mxHierarchicalLayout.prototype.traverse=function(a,b,c,d,e,f,g){if(a!=null&&d!=null){var h=mxObjectIdentity.get(a);if(d[h]==null&&(g==null||g[h]!=null)){e[h]==null&&(e[h]=a);d[h]==null&&(d[h]=a);g!==null&&delete g[h];for(var k=this.getEdges(a),h=[],c=0;c<k.length;c++)h[c]=this.getVisibleTerminal(k[c],true)==a;for(c=0;c<k.length;c++)if(!b||h[c]){for(var a=this.getVisibleTerminal(k[c],!h[c]),i=1,l=0;l<k.length;l++)if(l!=c){var m=h[l];this.getVisibleTerminal(k[l],!m)==a&&(m?i++:i--)}i>=0&&(e=this.traverse(a,
b,k[c],d,e,f,g))}}else if(e[h]==null)for(c=0;c<f.length;c++){b=f[c];if(b[h]!=null){for(k in b)e[k]=b[k];f.splice(c,1);break}}}return e};mxHierarchicalLayout.prototype.cycleStage=function(a){(new mxMinimumCycleRemover(this)).execute(a)};mxHierarchicalLayout.prototype.layeringStage=function(){this.model.initialRank();this.model.fixRanks()};mxHierarchicalLayout.prototype.crossingStage=function(a){(new mxMedianHybridCrossingReduction(this)).execute(a)};
...
mxPrintPreview.prototype.open=function(a){var b=this.graph.cellRenderer.initializeOverlay,c=null;try{if(this.printOverlays)this.graph.cellRenderer.initializeOverlay=function(a,b){b.init(a.view.getDrawPane())};if(this.wnd==null){this.wnd=window.open();var d=this.wnd.document,e=this.getDoctype();e!=null&&e.length>0&&d.writeln(e);d.writeln("<html>");d.writeln("<head>");this.writeHead(d,a);mxClient.link("stylesheet",mxClient.basePath+"/css/common.css",d);if(mxClient.IS_VML){d.namespaces.add("v","urn:schemas-microsoft-com:vml");
d.namespaces.add("o","urn:schemas-microsoft-com:office:office");d.createStyleSheet().cssText="v\\:*{behavior:url(#default#VML)}o\\:*{behavior:url(#default#VML)}";mxClient.link("stylesheet",mxClient.basePath+"/css/explorer.css",d)}d.writeln("</head>");d.writeln('<body class="mxPage">');var f=this.graph.getGraphBounds().clone(),g=this.graph.getView().getScale(),h=g/this.scale,k=this.graph.getView().getTranslate();if(!this.autoOrigin){this.x0=-k.x*this.scale;this.y0=-k.y*this.scale;f.width=f.width+f.x;
f.height=f.height+f.y;f.x=0;this.border=f.y=0}f.width=f.width/h;f.height=f.height/h;var i=this.pageFormat.width-this.border*2,l=this.pageFormat.height-this.border*2,m=Math.max(1,Math.ceil((f.width+this.x0)/i)),n=Math.max(1,Math.ceil((f.height+this.y0)/l));this.pageCount=m*n;var o=mxUtils.bind(this,function(){if(this.pageSelector&&(n>1||m>1)){var a=this.createPageSelector(n,m);d.body.appendChild(a);if(mxClient.IS_IE){a.style.position="absolute";var b=function(){a.style.top=d.body.scrollTop+10+"px"};
mxEvent.addListener(this.wnd,"scroll",function(){b()});mxEvent.addListener(this.wnd,"resize",function(){b()})}}}),p=null;if(mxClient.IS_IE&&document.documentMode!=9){var p=[],q=0,r=false,u=mxImageShape.prototype.scheduleUpdateAspect,w=mxImageShape.prototype.updateAspect,v=function(){if(r&&q==0){mxImageShape.prototype.scheduleUpdateAspect=u;mxImageShape.prototype.updateAspect=w;for(var a="",b=0;b<p.length;b++){a=a+p[b].outerHTML;p[b].parentNode.removeChild(p[b]);b<p.length-1&&(a=a+"<hr/>")}d.body.innerHTML=
a;o()}};mxImageShape.prototype.scheduleUpdateAspect=function(){q++;u.apply(this,arguments)};mxImageShape.prototype.updateAspect=function(){w.apply(this,arguments);q--;v()}}for(a=0;a<n;a++)for(var s=a*l/this.scale-this.y0/this.scale+(f.y-k.y*g)/g,e=0;e<m;e++){if(this.wnd==null)return null;h=a*m+e+1;c=this.renderPage(this.pageFormat.width,this.pageFormat.height,-(e*i/this.scale-this.x0/this.scale+(f.x-k.x*g)/g),-s,this.scale,h);c.setAttribute("id","mxPage-"+h);if(this.borderColor!=null){c.style.borderColor=
this.borderColor;c.style.borderStyle="solid";c.style.borderWidth="1px"}c.style.background="white";if(a<n-1||e<m-1)c.style.pageBreakAfter="always";if(mxClient.IS_IE){d.writeln(c.outerHTML);p!=null?p.push(c):c.parentNode.removeChild(c)}else{c.parentNode.removeChild(c);d.body.appendChild(c)}if(a<n-1||e<m-1){var t=d.createElement("hr");t.className="mxPageBreak";d.body.appendChild(t)}}d.writeln("</body>");d.writeln("</html>");d.close();if(p!=null){r=true;v()}else o();mxEvent.release(d.body)}this.wnd.focus()}catch(y){c!=
...
mxPrintPreview.prototype.createPageSelector=function(a,b){var c=this.wnd.document,d=c.createElement("table");d.className="mxPageSelector";d.setAttribute("border","0");for(var e=c.createElement("tbody"),f=0;f<a;f++){for(var g=c.createElement("tr"),h=0;h<b;h++){var k=f*b+h+1,i=c.createElement("td"),l=c.createElement("a");l.setAttribute("href","#mxPage-"+k);mxClient.IS_NS&&(!mxClient.IS_SF&&!mxClient.IS_GC)&&l.setAttribute("onclick","var page = document.getElementById('mxPage-"+k+"');page.scrollIntoView(true);event.preventDefault();");
mxUtils.write(l,k,c);i.appendChild(l);g.appendChild(i)}e.appendChild(g)}d.appendChild(e);return d};mxPrintPreview.prototype.getRoot=function(){var a=this.graph.view.currentRoot;a==null&&(a=this.graph.getModel().getRoot());return a};
mxPrintPreview.prototype.renderPage=function(a,b,c,d,e){var f=document.createElement("div");try{f.style.width=a+"px";f.style.height=b+"px";f.style.overflow="hidden";f.style.pageBreakInside="avoid";var g=document.createElement("div");g.style.top=this.border+"px";g.style.left=this.border+"px";g.style.width=a-2*this.border+"px";g.style.height=b-2*this.border+"px";g.style.overflow="hidden";if(this.graph.dialect==mxConstants.DIALECT_VML)g.style.position="absolute";f.appendChild(g);document.body.appendChild(f);
var h=this.graph.getView(),k=this.graph.container;this.graph.container=g;var i=h.getCanvas(),l=h.getBackgroundPane(),m=h.getDrawPane(),n=h.getOverlayPane();this.graph.dialect==mxConstants.DIALECT_SVG?h.createSvg():this.graph.dialect==mxConstants.DIALECT_VML?h.createVml():h.createHtml();var o=h.isEventsEnabled();h.setEventsEnabled(false);var p=this.graph.isEnabled();this.graph.setEnabled(false);var q=h.getTranslate();h.translate=new mxPoint(c,d);a=null;try{var r=[this.getRoot()],a=new mxTemporaryCellStates(h,
e,r)}finally{if(mxClient.IS_IE)h.overlayPane.innerHTML="";else for(var u=g.firstChild;u!=null;){var w=u.nextSibling,v=u.nodeName.toLowerCase();if(v=="svg"){u.setAttribute("width",parseInt(g.style.width));u.setAttribute("height",parseInt(g.style.height))}else u.style.cursor!="default"&&v!="table"&&u.parentNode.removeChild(u);u=w}h.overlayPane.parentNode.removeChild(h.overlayPane);this.graph.setEnabled(p);this.graph.container=k;h.canvas=i;h.backgroundPane=l;h.drawPane=m;h.overlayPane=n;h.translate=
q;a.destroy();h.setEventsEnabled(o)}}catch(s){f.parentNode.removeChild(f);throw s;}return f};mxPrintPreview.prototype.print=function(a){a=this.open(a);a!=null&&a.print()};mxPrintPreview.prototype.close=function(){if(this.wnd!=null){this.wnd.close();this.wnd=null}};function mxStylesheet(){this.styles={};this.putDefaultVertexStyle(this.createDefaultVertexStyle());this.putDefaultEdgeStyle(this.createDefaultEdgeStyle())}
...
null&&this.graph.getView().getState(this.editingCell)==null&&this.stopEditing(true)});this.graph.getModel().addListener(mxEvent.CHANGE,this.changeHandler)};mxCellEditor.prototype.isModified=function(){return this.modified};mxCellEditor.prototype.setModified=function(a){this.modified=a};mxCellEditor.prototype.focusLost=function(){this.stopEditing(!this.graph.isInvokesStopCellEditing())};
...
mxCellRenderer.prototype.getLabelBounds=function(a){var b=a.view.graph,c=b.getModel().isEdge(a.cell),d=new mxRectangle(a.absoluteOffset.x,a.absoluteOffset.y);if(!c){d.x=d.x+a.x;d.y=d.y+a.y;d.width=Math.max(1,a.width);d.height=Math.max(1,a.height);if(b.isSwimlane(a.cell)){c=b.view.scale;b=b.getStartSize(a.cell);if(b.width>0)d.width=b.width*c;else if(b.height>0)d.height=b.height*c}}a.shape!=null&&(d=a.shape.getLabelBounds(d));return d};
...
1;if(d!=null&&d.length>0){for(var h=a.view.transformControlPoint(a,d[0]),l=b,m=f[0],n=false,o=false,n=h,p=d.length,q=0;q<2;q++){var r=m!=null&&m.x==n.x,u=m!=null&&m.y==n.y,w=l!=null&&n.y>=l.y&&n.y<=l.y+l.height,l=l!=null&&n.x>=l.x&&n.x<=l.x+l.width,n=u||m==null&&w,o=r||m==null&&l;if(m!=null&&!u&&!r&&(w||l)){g=w?false:true;break}if(o||n){g=n;q==1&&(g=d.length%2==0?n:o);break}l=c;m=f[i];n=a.view.transformControlPoint(a,d[p-1])}g&&(f[0]!=null&&f[0].y!=h.y||f[0]==null&&b!=null&&(h.y<b.y||h.y>b.y+b.height))?
...
b,c,d,e);else{var d=a.absolutePoints,h=d[0],k=d[d.length-1],d=b!=null?b.x:h.x,g=b!=null?b.y:h.y,i=b!=null?b.width:0,l=b!=null?b.height:0,m=c!=null?c.x:k.x,n=c!=null?c.y:k.y,o=c!=null?c.width:0,p=c!=null?c.height:0,f=a.view.scale*mxEdgeStyle.orthBuffer,q=[mxConstants.DIRECTION_MASK_ALL,mxConstants.DIRECTION_MASK_ALL];b!=null&&(q[0]=mxUtils.getPortConstraints(b,a,true,mxConstants.DIRECTION_MASK_ALL));c!=null&&(q[1]=mxUtils.getPortConstraints(c,a,false,mxConstants.DIRECTION_MASK_ALL));a=[0,0];d=[[d,
...
mxEdgeStyle.wayPoints1[f][0]=mxEdgeStyle.wayPoints1[f-1][0];mxEdgeStyle.wayPoints1[f][1]=mxEdgeStyle.wayPoints1[f-1][1]}var r=(q[i]&mxEdgeStyle.TARGET_MASK)>0,o=(q[i]&mxEdgeStyle.SOURCE_MASK)>0,m=(q[i]&mxEdgeStyle.SIDE_MASK)>>5,m=m<<g;m>15&&(m=m>>4);n=(q[i]&mxEdgeStyle.CENTER_MASK)>0;if((o||r)&&m<9){p=0;o=o?0:1;p=n&&k==0?d[o][0]+b[o][0]*d[o][2]:n?d[o][1]+b[o][1]*d[o][3]:mxEdgeStyle.limits[o][m];if(k==0){m=(p-mxEdgeStyle.wayPoints1[f][0])*l[0];m>0&&(mxEdgeStyle.wayPoints1[f][0]=mxEdgeStyle.wayPoints1[f][0]+
...
mxGraph.prototype.processChange=function(a){if(a instanceof mxRootChange){this.clearSelection();this.removeStateForCell(a.previous);if(this.resetViewOnRootChange){this.view.scale=1;this.view.translate.x=0;this.view.translate.y=0}this.fireEvent(new mxEventObject(mxEvent.ROOT))}else if(a instanceof mxChildChange){var b=this.model.getParent(a.child);if(b!=null&&!this.isCellCollapsed(b))this.view.invalidate(a.child,true,false,a.previous!=null);else{this.removeStateForCell(a.child);this.view.currentRoot==
a.child&&this.home()}if(b!=a.previous){b!=null&&this.view.invalidate(b,false,false);a.previous!=null&&this.view.invalidate(a.previous,false,false)}}else if(a instanceof mxTerminalChange||a instanceof mxGeometryChange)(a instanceof mxTerminalChange||a.previous==null&&a.geometry!=null||a.previous!=null&&!a.previous.equals(a.geometry))&&this.view.invalidate(a.cell);else if(a instanceof mxValueChange)this.view.invalidate(a.cell,false,false);else if(a instanceof mxStyleChange){this.view.invalidate(a.cell,
true,true,false);this.view.removeState(a.cell)}else a.cell!=null&&a.cell instanceof mxCell&&this.removeStateForCell(a.cell)};mxGraph.prototype.removeStateForCell=function(a){for(var b=this.model.getChildCount(a),c=0;c<b;c++)this.removeStateForCell(this.model.getChildAt(a,c));this.view.removeState(a)};
...
mxGraph.prototype.dblClick=function(a,b){var c=new mxEventObject(mxEvent.DOUBLE_CLICK,"event",a,"cell",b);this.fireEvent(c);if(this.isEnabled()&&!mxEvent.isConsumed(a)&&!c.isConsumed()&&b!=null&&this.isCellEditable(b)){this.startEditingAtCell(b,a);mxEvent.consume(a)}};
...
mxGraph.prototype.getDropTarget=function(a,b,c){if(!this.isSwimlaneNesting())for(var d=0;d<a.length;d++)if(this.isSwimlane(a[d]))return null;b=mxUtils.convertPoint(this.container,mxEvent.getClientX(b),mxEvent.getClientY(b));b.x=b.x-this.panDx;b.y=b.y-this.panDy;b=this.getSwimlaneAt(b.x,b.y);if(c==null)c=b;else if(b!=null){for(d=this.model.getParent(b);d!=null&&this.isSwimlane(d)&&d!=c;)d=this.model.getParent(d);d==c&&(c=b)}for(b=c;b!=null&&mxUtils.indexOf(a,b)<0;)b=this.model.getParent(b);return!this.model.isLayer(c)&&
b==null?c:null};mxGraph.prototype.getDefaultParent=function(){var a=this.getCurrentRoot();if(a==null){a=this.defaultParent;a==null&&(a=this.model.getChildAt(this.model.getRoot(),0))}return a};mxGraph.prototype.setDefaultParent=function(a){this.defaultParent=a};mxGraph.prototype.getSwimlane=function(a){for(;a!=null&&!this.isSwimlane(a);)a=this.model.getParent(a);return a};
...
this.outline.getView().scale,c=new mxRectangle(this.bounds.x+d,this.bounds.y+e,this.bounds.width,this.bounds.height);this.selectionBorder.bounds=c;this.selectionBorder.redraw();d=d/f*this.source.getView().scale;e=e/f*this.source.getView().scale;this.source.panGraph(-d-this.dx0,-e-this.dy0)}d=this.sizer.bounds;this.sizer.bounds=new mxRectangle(c.x+c.width-d.width/2,c.y+c.height-d.height/2,d.width,d.height);this.sizer.node.style.visibility!="hidden"&&this.sizer.redraw();b.consume()}};
mxOutline.prototype.getTranslateForEvent=function(a){return new mxPoint(a.getX()-this.startX,a.getY()-this.startY)};
mxOutline.prototype.mouseUp=function(a,b){if(this.active){var c=this.getTranslateForEvent(b),d=c.x,c=c.y;if(Math.abs(d)>0||Math.abs(c)>0){if(this.zoom){var c=this.selectionBorder.bounds.width,e=this.source.getView().scale;this.source.zoomTo(e-d*e/c,false)}else if(!this.source.useScrollbarsForPanning||!mxUtils.hasScrollbars(this.source.container)){this.source.panGraph(0,0);d=d/this.outline.getView().scale;c=c/this.outline.getView().scale;e=this.source.getView().translate;this.source.getView().setTranslate(e.x-
...
e=null;d=b.getCell();c.isDropEnabled()&&this.highlightEnabled&&(e=c.getDropTarget(this.cells,b.getEvent(),d));f=c.isCloneEvent(b.getEvent())&&c.isCellsCloneable()&&this.isCloneEnabled();g=c.getView().getState(e);h=false;if(g!=null&&(c.model.getParent(this.cell)!=e||f)){if(this.target!=e){this.target=e;this.setHighlightColor(mxConstants.DROP_TARGET_COLOR)}h=true}else{this.target=null;if(this.connectOnDrop&&d!=null&&this.cells.length==1&&c.getModel().isVertex(d)&&c.isCellConnectable(d)){g=c.getView().getState(d);
if(g!=null){this.setHighlightColor(c.getEdgeValidationError(null,this.cell,d)==null?mxConstants.VALID_COLOR:mxConstants.INVALID_CONNECT_TARGET_COLOR);h=true}}}g!=null&&h?this.highlight.highlight(g):this.highlight.hide()}b.consume();mxEvent.consume(b.getEvent())}else if((this.isMoveEnabled()||this.isCloneEnabled())&&this.updateCursor&&!b.isConsumed()&&b.getState()!=null&&!c.isMouseDown){e=c.getCursorForCell(b.getCell());e==null&&(c.isEnabled()&&c.isCellMovable(b.getCell()))&&(e=c.getModel().isEdge(b.getCell())?
...
mxConnectionHandler.prototype.destroyIcons=function(){if(this.icons!=null){for(var a=0;a<this.icons.length;a++)this.icons[a].destroy();this.iconState=this.selectedIcon=this.icon=this.icons=null}};mxConnectionHandler.prototype.isStartEvent=function(a){return!this.graph.isForceMarqueeEvent(a.getEvent())&&(this.constraintHandler.currentFocus!=null&&this.constraintHandler.currentConstraint!=null||this.previous!=null&&this.error==null&&(this.icons==null||this.icons!=null&&this.icon!=null))};
...
mxConstraintHandler.prototype.getImageForConstraint=function(){return this.pointImage};mxConstraintHandler.prototype.isEventIgnored=function(){return false};mxConstraintHandler.prototype.isStateIgnored=function(){return false};
...
mxEdgeHandler.prototype.createMarker=function(){var a=new mxCellMarker(this.graph),b=this;a.getCell=function(a){var d=mxCellMarker.prototype.getCell.apply(this,arguments);if(!b.isConnectableCell(d))return null;var e=b.graph.getModel();if(d==b.state.cell||d!=null&&!b.graph.connectableEdges&&e.isEdge(d)||e.isAncestor(b.state.cell,d))d=null;return d};a.isValidState=function(a){var d=b.graph.getModel(),d=b.graph.view.getTerminalPort(a,b.graph.view.getState(d.getTerminal(b.state.cell,!b.isSource)),!b.isSource),
d=d!=null?d.cell:null;b.error=b.validateConnection(b.isSource?a.cell:d,b.isSource?d:a.cell);return b.error==null};return a};mxEdgeHandler.prototype.validateConnection=function(a,b){return this.graph.getEdgeValidationError(this.state.cell,a,b)};
...
mxElbowEdgeHandler.prototype.redrawInnerBends=function(a,b){var c=this.graph.getModel().getGeometry(this.state.cell),d=this.state.absolutePoints,e=null;if(d.length>1){a=d[1];b=d[d.length-2]}else c.points!=null&&c.points.length>0&&(e=d[0]);e=e==null?new mxPoint(a.x+(b.x-a.x)/2,a.y+(b.y-a.y)/2):new mxPoint(this.graph.getView().scale*(e.x+this.graph.getView().translate.x+this.state.origin.x),this.graph.getView().scale*(e.y+this.graph.getView().translate.y+this.state.origin.y));d=this.bends[1].bounds;
c=d.width;d=d.height;if(this.handleImage==null)d=c=mxConstants.HANDLE_SIZE;var f=new mxRectangle(e.x-c/2,e.y-d/2,c,d);if(this.handleImage==null&&this.labelShape.node.style.visibility!="hidden"&&mxUtils.intersects(f,this.labelShape.bounds)){c=c+3;d=d+3;f=new mxRectangle(e.x-c/2,e.y-d/2,c,d)}this.bends[1].bounds=f;this.bends[1].reconfigure();this.bends[1].redraw()};function mxEdgeSegmentHandler(a){if(a!=null){this.state=a;this.init()}}mxEdgeSegmentHandler.prototype=new mxElbowEdgeHandler;
...
mxEditor.prototype.showOutline=function(){if(this.outline==null){var a=document.createElement("div");a.style.overflow="hidden";a.style.position="absolute";a.style.width="100%";a.style.height="100%";a.style.background="white";a.style.cursor="move";var b=new mxWindow(mxResources.get(this.outlineResource)||this.outlineResource,a,600,480,200,200,false),c=new mxOutline(this.graph,a);b.setClosable(true);b.setResizable(true);b.destroyOnClose=false;b.addListener(mxEvent.RESIZE_END,function(){c.update()});
this.outline=b;this.outline.outline=c}this.outline.setVisible(true);this.outline.outline.update(true)};mxEditor.prototype.setMode=function(a){if(a=="select"){this.graph.panningHandler.useLeftButtonForPanning=false;this.graph.setConnectable(false)}else if(a=="connect"){this.graph.panningHandler.useLeftButtonForPanning=false;this.graph.setConnectable(true)}else if(a=="pan"){this.graph.panningHandler.useLeftButtonForPanning=true;this.graph.setConnectable(false)}};
...
mxCodec.prototype.encode=function(a){var b=null;if(a!=null&&a.constructor!=null){var c=mxCodecRegistry.getCodec(a.constructor);c!=null?b=c.encode(this,a):mxUtils.isNode(a)?b=mxUtils.importNode(this.document,a,true):mxLog.warn("mxCodec.encode: No codec for "+mxUtils.getFunctionName(a.constructor))}return b};
...
if(h.length>0)if(g==null){l=d.addActionCombo(f);for(f=0;f<h.length;f++){m=h[f];if(m.nodeName=="separator")d.addOption(l,"---");else if(m.nodeName=="add"){g=m.getAttribute("as");m=m.getAttribute("action");d.addActionOption(l,g,m)}}}else{var q=null,r=d.addPrototype(f,g,function(){var a=e.templates[q.value];if(a!=null){var a=a.clone(),b=q.options[q.selectedIndex].cellStyle;b!=null&&a.setStyle(b);return a}mxLog.warn("Template "+a+" not found");return null},null,null,m),q=d.addCombo();mxEvent.addListener(q,
"change",function(){d.toolbar.selectMode(r,function(a){a=mxUtils.convertPoint(e.graph.container,mxEvent.getClientX(a),mxEvent.getClientY(a));return e.addVertex(null,p(),a.x,a.y)});d.toolbar.noReset=false});for(f=0;f<h.length;f++){m=h[f];if(m.nodeName=="separator")d.addOption(q,"---");else if(m.nodeName=="add"){g=m.getAttribute("as");n=m.getAttribute("template");d.addOption(q,g,n||l).cellStyle=m.getAttribute("style")}}}}if(o!=null){l=c.getAttribute("id");l!=null&&l.length>0&&o.setAttribute("id",l)}}c=
