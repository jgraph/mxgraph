...
navigator.userAgent.indexOf("AppleWebKit/")||0<=navigator.userAgent.indexOf("Gecko/")||0<=navigator.userAgent.indexOf("Opera/")||null!=document.documentMode&&9<=document.documentMode,NO_FO:0<=navigator.userAgent.indexOf("Firefox/1.")||0<=navigator.userAgent.indexOf("Iceweasel/1.")||0<=navigator.userAgent.indexOf("Firefox/2.")||0<=navigator.userAgent.indexOf("Iceweasel/2.")||0<=navigator.userAgent.indexOf("SeaMonkey/1.")||0<=navigator.userAgent.indexOf("Iceape/1.")||0<=navigator.userAgent.indexOf("Camino/1.")||
0<=navigator.userAgent.indexOf("Epiphany/2.")||0<=navigator.userAgent.indexOf("Opera/")||0<=navigator.userAgent.indexOf("MSIE")||0<=navigator.userAgent.indexOf("Mozilla/2."),IS_VML:"MICROSOFT INTERNET EXPLORER"==navigator.appName.toUpperCase(),IS_MAC:0<navigator.userAgent.toUpperCase().indexOf("MACINTOSH"),IS_TOUCH:0<navigator.userAgent.toUpperCase().indexOf("IPAD")||0<navigator.userAgent.toUpperCase().indexOf("IPOD")||0<navigator.userAgent.toUpperCase().indexOf("IPHONE")||0<navigator.userAgent.toUpperCase().indexOf("ANDROID"),
...
include:function(a){document.write('<script src="'+a+'"><\/script>')},dispose:function(){for(var a=0;a<mxEvent.objects.length;a++)null!=mxEvent.objects[a].mxListenerList&&mxEvent.removeAllListeners(mxEvent.objects[a])}};"undefined"==typeof mxLoadResources&&(mxLoadResources=!0);"undefined"==typeof mxLoadStylesheets&&(mxLoadStylesheets=!0);
...
e*2/Math.PI,g=Math.ceil(g<0?-1*g:g),e=e/g,i=8/3*Math.sin(e/4)*Math.sin(e/4)/Math.sin(e/2),l=m*c,m=m*d,c=n*c,d=n*d,u=Math.cos(f),v=Math.sin(f),o=-i*(l*v+d*u),p=-i*(c*v-m*u),r=q=0,n=[],w=0;w<g;++w){var f=f+e,u=Math.cos(f),v=Math.sin(f),q=l*u-d*v+h,r=c*u+m*v+k,s=-i*(l*v+d*u),u=-i*(c*v-m*u),v=w*6;n[v]=Number(o+a);n[v+1]=Number(p+b);n[v+2]=Number(q-s+a);n[v+3]=Number(r-u+b);n[v+4]=Number(q+a);n[v+5]=Number(r+b);o=q+s;p=r+u}return n},getBoundingBox:function(a,b){var c=null;if(a!=null&&b!=null&&b!=0){var d=
...
"0");a.appendChild(r)},text:function(b,c,f,g,n,o,p,q,r,u){if(d){var v=e.createElement("text");v.setAttribute("x",h(b));v.setAttribute("y",h(c));v.setAttribute("w",h(f));v.setAttribute("h",h(g));v.setAttribute("str",n);o!=null&&v.setAttribute("align",o);p!=null&&v.setAttribute("valign",p);v.setAttribute("vertical",q?"1":"0");v.setAttribute("wrap",r?"1":"0");v.setAttribute("format",u);a.appendChild(v)}},begin:function(){a.appendChild(e.createElement("begin"))},moveTo:function(b,c){var d=e.createElement("move");
...
c.fill!=null&&c.fillColorAssigned&&b.setAttribute("fill",c.fill);c.stroke!=null&&b.setAttribute("stroke",c.stroke)}},z=function(a){t!=null&&y!=null&&y.push(a)},x=function(a){return e?Math.round(a):a},C=function(d){var g=d.nodeName,h=g=="fill",i=g=="stroke",k=g=="fillstroke";if(g=="save"){w.push(s);s=mxUtils.clone(s)}else if(g=="restore")s=w.pop();else if(g=="path"){y=[];if(e){t=document.createElement("v:shape");B.call(this,t,s);k=Math.round(b.width)*f;g=Math.round(b.height)*f;t.style.width=k+"px";
t.style.height=g+"px";t.coordsize=k+","+g}else{t=document.createElementNS(mxConstants.NS_SVG,"path");B.call(this,t,s);l.length>0&&t.setAttribute("transform",l);d.getAttribute("crisp")=="1"&&t.setAttribute("shape-rendering","crispEdges")}for(d=d.firstChild;d!=null;){d.nodeType==mxConstants.NODETYPE_ELEMENT&&C.call(this,d);d=d.nextSibling}if(e){z("e");t.path=y.join("")}else t.setAttribute("d",y.join(""))}else if(g=="move"){h=e?"m":"M";this.lastMoveX=x(r+Number(d.getAttribute("x"))*m);this.lastMoveY=
x(u+Number(d.getAttribute("y"))*n);z(h+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="line"){h=e?"l":"L";this.lastMoveX=x(r+Number(d.getAttribute("x"))*m);this.lastMoveY=x(u+Number(d.getAttribute("y"))*n);z(h+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="quad")if(e){var h=this.lastMoveX,o=this.lastMoveY,i=r+Number(d.getAttribute("x1"))*m,g=u+Number(d.getAttribute("y1"))*n,k=r+Number(d.getAttribute("x2"))*m,d=u+Number(d.getAttribute("y2"))*n,o=o+2/3*(g-o),p=k+2/3*(i-k),g=d+2/3*(g-d);z("c "+
Math.round(h+2/3*(i-h))+" "+Math.round(o)+" "+Math.round(p)+" "+Math.round(g)+" "+Math.round(k)+" "+Math.round(d));this.lastMoveX=k;this.lastMoveY=d}else{this.lastMoveX=r+Number(d.getAttribute("x2"))*m;this.lastMoveY=u+Number(d.getAttribute("y2"))*n;z("Q "+(r+Number(d.getAttribute("x1"))*m)+" "+(u+Number(d.getAttribute("y1"))*n)+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="curve"){h=e?"c":"C";this.lastMoveX=x(r+Number(d.getAttribute("x3"))*m);this.lastMoveY=x(u+Number(d.getAttribute("y3"))*
n);z(h+" "+x(r+Number(d.getAttribute("x1"))*m)+" "+x(u+Number(d.getAttribute("y1"))*n)+" "+x(r+Number(d.getAttribute("x2"))*m)+" "+x(u+Number(d.getAttribute("y2"))*n)+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="close")z(e?"x":"Z");else if(g=="rect"||g=="roundrect"){o=g=="roundrect";i=x(r+Number(d.getAttribute("x"))*m);h=x(u+Number(d.getAttribute("y"))*n);k=x(Number(d.getAttribute("w"))*m);g=x(Number(d.getAttribute("h"))*n);p=d.getAttribute("arcsize");p==0&&(p=mxConstants.RECTANGLE_ROUNDING_FACTOR*
100);if(e){t=document.createElement(o?"v:roundrect":"v:rect");t.style.left=i+"px";t.style.top=h+"px";t.style.width=k+"px";t.style.height=g+"px";o&&t.setAttribute("arcsize",""+p+"%")}else{t=document.createElementNS(mxConstants.NS_SVG,"rect");t.setAttribute("x",i);t.setAttribute("y",h);t.setAttribute("width",k);t.setAttribute("height",g);if(o){h=Number(p)/100;h=Math.min(k*h,g*h);t.setAttribute("rx",h);t.setAttribute("ry",h)}l.length>0&&t.setAttribute("transform",l);d.getAttribute("crisp")=="1"&&t.setAttribute("shape-rendering",
"crispEdges")}B.call(this,t,s)}else if(g=="ellipse"){i=x(r+Number(d.getAttribute("x"))*m);h=x(u+Number(d.getAttribute("y"))*n);k=x(Number(d.getAttribute("w"))*m);g=x(Number(d.getAttribute("h"))*n);if(e){t=document.createElement("v:arc");t.startangle="0";t.endangle="360";t.style.left=i+"px";t.style.top=h+"px";t.style.width=k+"px";t.style.height=g+"px"}else{t=document.createElementNS(mxConstants.NS_SVG,"ellipse");t.setAttribute("cx",i+k/2);t.setAttribute("cy",h+g/2);t.setAttribute("rx",k/2);t.setAttribute("ry",
g/2);l.length>0&&t.setAttribute("transform",l)}B.call(this,t,s)}else if(g=="arc"){var k=Number(d.getAttribute("rx"))*m,g=Number(d.getAttribute("ry"))*n,o=Number(d.getAttribute("x-axis-rotation")),p=Number(d.getAttribute("large-arc-flag")),A=Number(d.getAttribute("sweep-flag")),i=r+Number(d.getAttribute("x"))*m,h=u+Number(d.getAttribute("y"))*n;if(e){h=mxUtils.arcToCurves(this.lastMoveX,this.lastMoveY,k,g,o,p,A,i,h);for(d=0;d<h.length;d=d+6){z("c "+Math.round(h[d])+" "+Math.round(h[d+1])+" "+Math.round(h[d+
2])+" "+Math.round(h[d+3])+" "+Math.round(h[d+4])+" "+Math.round(h[d+5]));this.lastMoveX=h[d+4];this.lastMoveY=h[d+5]}}else{z("A "+k+","+g+" "+o+" "+p+","+A+" "+i+","+h);this.lastMoveX=r+i;this.lastMoveY=u+h}}else if(g=="image"){o=this.evaluateAttribute(d,"src",a.state);if(o!=null){i=x(r+Number(d.getAttribute("x"))*m);h=x(u+Number(d.getAttribute("y"))*n);k=x(Number(d.getAttribute("w"))*m);g=x(Number(d.getAttribute("h"))*n);p=d.getAttribute("flipH")=="1";A=d.getAttribute("flipV")=="1";if(e){t=document.createElement("v:image");
t.style.filter="alpha(opacity="+s.alpha+")";t.style.left=i+"px";t.style.top=h+"px";t.style.width=k+"px";t.style.height=g+"px";t.src=o;if(p&&A)t.style.rotation="180";else if(p)t.style.flip="x";else if(A)t.style.flip="y"}else{t=document.createElementNS(mxConstants.NS_SVG,"image");t.setAttributeNS(mxConstants.NS_XLINK,"xlink:href",o);t.setAttribute("opacity",s.alpha/100);t.setAttribute("x",i);t.setAttribute("y",h);t.setAttribute("width",k);t.setAttribute("height",g);t.setAttribute("preserveAspectRatio",
"none");if(p||A){var D=1,E=1,o=d=0;if(p){D=-1;d=-k-2*i}if(A){E=-1;o=-g-2*h}t.setAttribute("transform",l+"scale("+D+" "+E+") translate("+d+" "+o+") ")}else t.setAttribute("transform",l)}c.appendChild(t)}}else if(g=="include-shape"){o=mxStencilRegistry.getStencil(d.getAttribute("name"));if(o!=null){i=r+Number(d.getAttribute("x"))*m;h=u+Number(d.getAttribute("y"))*n;k=Number(d.getAttribute("w"))*m;g=Number(d.getAttribute("h"))*n;o.renderDom(a,new mxRectangle(i,h,k,g),c,s)}}else if(g=="text"){k=this.evaluateTextAttribute(d,
"str",a.state);if(k!=null){i=x(r+Number(d.getAttribute("x"))*m);h=x(u+Number(d.getAttribute("y"))*n);g=d.getAttribute("align")||"left";o=d.getAttribute("valign")||"top";if(e){t=document.createElement("v:shape");t.style.position="absolute";t.style.width="1px";t.style.height="1px";t.style.left=i+"px";t.style.top=h+"px";d=document.createElement("v:fill");d.color=s.fontColor;d.on="true";t.appendChild(d);d=document.createElement("v:stroke");d.on="false";t.appendChild(d);d=document.createElement("v:path");
d.textpathok="true";d.v="m "+i+" "+h+" l "+(i+1)+" "+h;t.appendChild(d);d=document.createElement("v:textpath");d.style.cssText="v-text-align:"+g;d.style.fontSize=Math.round(s.fontSize/f)+"px";d.style.fontFamily=s.fontFamily;d.string=k;d.on="true";if((s.fontStyle&mxConstants.FONT_BOLD)==mxConstants.FONT_BOLD)d.style.fontWeight="bold";if((s.fontStyle&mxConstants.FONT_ITALIC)==mxConstants.FONT_ITALIC)d.style.fontStyle="italic";if((s.fontStyle&mxConstants.FONT_UNDERLINE)==mxConstants.FONT_UNDERLINE)d.style.textDecoration=
"underline";if(o=="top")t.style.top=h+s.fontSize/2+"px";else if(o=="bottom")t.style.top=h-s.fontSize/3+"px";t.appendChild(d)}else{t=document.createElementNS(mxConstants.NS_SVG,"text");t.setAttribute("fill",s.fontColor);t.setAttribute("font-family",s.fontFamily);t.setAttribute("font-size",s.fontSize);t.setAttribute("stroke","none");t.setAttribute("x",i);t.appendChild(document.createTextNode(k));(s.fontStyle&mxConstants.FONT_BOLD)==mxConstants.FONT_BOLD&&t.setAttribute("font-weight","bold");(s.fontStyle&
...
l)}c.appendChild(t)}}else if(h||i||k){if(t!=null){g=null;if(s.dashed){g=e?v:Number(t.getAttribute("stroke-width"));o=[];for(d=0;d<s.dashpattern.length;d++)o.push(Math.max(1,Math.round(Number(s.dashpattern[d])*g)));g=o.join(" ")}if(i||k)if(e){d=document.createElement("v:stroke");d.endcap=s.linecap||"flat";d.joinstyle=s.linejoin||"miter";d.miterlimit=s.miterlimit||"10";t.appendChild(d);if(g!=null)d.dashstyle=g}else{s.linejoin!=null&&t.setAttribute("stroke-linejoin",s.linejoin);if(s.linecap!=null){d=
...
100+"%");d=document.createElement("v:stroke");d.endcap=s.linecap||"flat";d.joinstyle=s.linejoin||"miter";d.miterlimit=s.miterlimit||"10";if(g!=null)d.dashstyle=g;p.appendChild(d);t.appendChild(p)}else{p=t.cloneNode(true);p.setAttribute("stroke",mxConstants.SHADOWCOLOR);s.fill!=null&&(h||k)?p.setAttribute("fill",mxConstants.SHADOWCOLOR):p.setAttribute("fill","none");p.setAttribute("transform","translate("+d+" "+o+") "+(p.getAttribute("transform")||""));p.setAttribute("opacity",mxConstants.SHADOW_OPACITY);
c.appendChild(p)}}if(h)e?t.stroked="false":t.setAttribute("stroke","none");else if(i)e?t.filled="false":t.setAttribute("fill","none");c.appendChild(t)}q&&(q=false)}else if(g=="linecap")s.linecap=d.getAttribute("cap");else if(g=="linejoin")s.linejoin=d.getAttribute("join");else if(g=="miterlimit")s.miterlimit=d.getAttribute("limit");else if(g=="dashed")s.dashed=d.getAttribute("dashed")=="1";else if(g=="dashpattern"){d=d.getAttribute("pattern");if(d!=null&&d.length>0)s.dashpattern=d.split(" ")}else if(g==
"strokewidth"){h=d.getAttribute("fixed")=="1"?1:v;s.strokeWidth=d.getAttribute("width")*h;if(e)s.strokeWidth=s.strokeWidth/f}else if(g=="strokecolor")s.stroke=d.getAttribute("color");else if(g=="fillcolor"){s.fill=d.getAttribute("color");s.fillColorAssigned=true}else if(g=="alpha")s.alpha=Number(d.getAttribute("alpha"));else if(g=="fontcolor")s.fontColor=d.getAttribute("color");else if(g=="fontsize")s.fontSize=Number(d.getAttribute("size"))*v;else if(g=="fontfamily")s.fontFamily=d.getAttribute("family");
...
mxMedianHybridCrossingReduction.prototype.transpose=function(a,b){for(var c=true,d=0;c&&d++<10;)for(var e=a%2==1&&d%2==1,c=false,f=0;f<b.ranks.length;f++){for(var g=b.ranks[f],h=[],k=0;k<g.length;k++){var i=g[k],l=i.getGeneralPurposeVariable(f);l<0&&(l=k);h[l]=i}for(var m=l=i=null,n=null,o=null,p=null,q=null,r=null,u=null,v=null,k=0;k<g.length-1;k++){if(k==0){for(var u=h[k],i=u.getNextLayerConnectedCells(f),l=u.getPreviousLayerConnectedCells(f),o=[],p=[],w=0;w<i.length;w++)o[w]=i[w].getGeneralPurposeVariable(f+
1);for(w=0;w<l.length;w++)p[w]=l[w].getGeneralPurposeVariable(f-1)}else{i=m;l=n;o=q;p=r;u=v}v=h[k+1];m=v.getNextLayerConnectedCells(f);n=v.getPreviousLayerConnectedCells(f);q=[];r=[];for(w=0;w<m.length;w++)q[w]=m[w].getGeneralPurposeVariable(f+1);for(w=0;w<n.length;w++)r[w]=n[w].getGeneralPurposeVariable(f-1);for(var s=0,t=0,w=0;w<o.length;w++)for(var y=0;y<q.length;y++){o[w]>q[y]&&s++;o[w]<q[y]&&t++}for(w=0;w<p.length;w++)for(y=0;y<r.length;y++){p[w]>r[y]&&s++;p[w]<r[y]&&t++}if(t<s||t==s&&e){m=u.getGeneralPurposeVariable(f);
u.setGeneralPurposeVariable(f,v.getGeneralPurposeVariable(f));v.setGeneralPurposeVariable(f,m);m=i;n=l;q=o;r=p;v=u;e||(c=true)}}}};mxMedianHybridCrossingReduction.prototype.weightedMedian=function(a,b){var c=a%2==0;if(c)for(var d=b.maxRank-1;d>=0;d--)this.medianRank(d,c);else for(d=1;d<b.maxRank;d++)this.medianRank(d,c)};
...
mxCoordinateAssignment.prototype.setEdgePosition=function(a){var b=0;if(a.temp[0]!=101207){var c=a.maxRank,d=a.minRank;if(c==d){c=a.source.maxRank;d=a.target.minRank}for(var e=0,f=this.jettyPositions[a.ids[0]],g=a.isReversed?a.target.cell:a.source.cell,h=this.layout.graph,k=0;k<a.edges.length;k++){var i=a.edges[k],l=this.layout.getVisibleTerminal(i,true),m=h.model.getTerminal(i,true),n=[],o=a.isReversed;l!=g&&(o=!o);if(f!=null){var p=o?2:0,q=o?this.rankTopY[d]:this.rankBottomY[c],r=f[e*4+1+p];o&&
(r=-r);q=q+r;p=f[e*4+p];m=h.model.getTerminal(i,true);if(this.layout.isPort(m)&&h.model.getParent(m)==l){p=h.view.getState(m);p=p!=null?p.x:l.geometry.x+a.source.width*m.geometry.x}if(this.orientation==mxConstants.DIRECTION_NORTH||this.orientation==mxConstants.DIRECTION_SOUTH){n.push(new mxPoint(p,q));this.edgeStyle==mxHierarchicalEdgeStyle.CURVE&&n.push(new mxPoint(p,q+r))}else{n.push(new mxPoint(q,p));this.edgeStyle==mxHierarchicalEdgeStyle.CURVE&&n.push(new mxPoint(q+r,p))}}p=a.x.length-1;q=r=
-1;l=a.maxRank-1;if(o){p=0;r=a.x.length;q=1;l=a.minRank+1}for(;a.maxRank!=a.minRank&&p!=r;p=p+q){var m=a.x[p]+b,u=(this.rankTopY[l]+this.rankBottomY[l+1])/2,v=(this.rankTopY[l-1]+this.rankBottomY[l])/2;if(o)var w=u,u=v,v=w;if(this.orientation==mxConstants.DIRECTION_NORTH||this.orientation==mxConstants.DIRECTION_SOUTH){n.push(new mxPoint(m,u));n.push(new mxPoint(m,v))}else{n.push(new mxPoint(u,m));n.push(new mxPoint(v,m))}this.limitX=Math.max(this.limitX,m);l=l+q}if(f!=null){p=o?2:0;q=o?this.rankBottomY[c]:
this.rankTopY[d];r=f[e*4+3-p];o&&(r=-r);q=q-r;p=f[e*4+2-p];o=h.model.getTerminal(i,false);l=this.layout.getVisibleTerminal(i,false);if(this.layout.isPort(o)&&h.model.getParent(o)==l){p=h.view.getState(o);p=p!=null?p.x:l.geometry.x+a.target.width*o.geometry.x}if(this.orientation==mxConstants.DIRECTION_NORTH||this.orientation==mxConstants.DIRECTION_SOUTH){this.edgeStyle==mxHierarchicalEdgeStyle.CURVE&&n.push(new mxPoint(p,q-r));n.push(new mxPoint(p,q))}else{this.edgeStyle==mxHierarchicalEdgeStyle.CURVE&&
n.push(new mxPoint(q-r,p));n.push(new mxPoint(q,p))}}a.isReversed&&this.processReversedEdge(a,i);this.layout.setEdgePoints(i,n);b=b==0?this.parallelEdgeSpacing:b>0?-b:-b+this.parallelEdgeSpacing;e++}a.temp[0]=101207}};
...
mxHierarchicalLayout.prototype.edgesCache=null;mxHierarchicalLayout.prototype.edgeSourceTermCache=null;mxHierarchicalLayout.prototype.edgesTargetTermCache=null;mxHierarchicalLayout.prototype.getModel=function(){return this.model};
mxHierarchicalLayout.prototype.execute=function(a,b){this.parent=a;var c=this.graph.model;this.edgesCache=new mxDictionary;this.edgeSourceTermCache=new mxDictionary;this.edgesTargetTermCache=new mxDictionary;b!=null&&!(b instanceof Array)&&(b=[b]);if(!(b==null&&a==null)){if(b!=null&&a!=null){for(var d=[],e=0;e<b.length;e++)c.isAncestor(a,b[e])&&d.push(b[e]);this.roots=d}else this.roots=b;c.beginUpdate();try{this.run(a);this.resizeParent&&!this.graph.isCellCollapsed(a)&&this.graph.updateGroupBounds([a],
this.parentBorder,this.moveParent)}finally{c.endUpdate()}}};mxHierarchicalLayout.prototype.findRoots=function(a,b){var c=[];if(a!=null&&b!=null){var d=this.graph.model,e=null,f=-1E5,g;for(g in b){var h=b[g];if(d.isVertex(h)&&this.graph.isCellVisible(h)){for(var k=this.getEdges(h),i=0,l=0,m=0;m<k.length;m++)this.getVisibleTerminal(k[m],true)==h?i++:l++;l==0&&i>0&&c.push(h);k=i-l;if(k>f){f=k;e=h}}}c.length==0&&e!=null&&c.push(e)}return c};
